CLASS z4ui5_cl_popup_file_upload DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)       TYPE REF TO z4ui5_cl_popup_file_upload.
...
CLASS z4ui5_cl_popup_file_upload IMPLEMENTATION.
  ...
  METHOD z4ui5_if_app~main.
    ...
    CASE client->get( )-event.
      ...
      WHEN `UPLOAD`.
        ...
        DATA(lv_data2) = z4ui5_cl_util=>conv_decode_x_base64( lv_data ).
        ms_result-value = z4ui5_cl_util=>conv_get_string_by_xstring( lv_data2 ).
