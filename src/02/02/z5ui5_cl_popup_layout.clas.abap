CLASS z5ui5_cl_popup_layout DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(result)    TYPE REF TO z5ui5_cl_popup_layout.
  ...
  PROTECTED SECTION.
    ...
    DATA client        TYPE REF TO z5ui5_if_client.
...
CLASS z5ui5_cl_popup_layout IMPLEMENTATION.
  ...
  METHOD db_delete_layout.
    ...
    DELETE  z5ui5_t001 FROM @layout-s_head.
    DELETE  z5ui5_t002 FROM TABLE @layout-t_layout.
  ...
  METHOD init_layout.
    ...
    DATA(t_comp)   = z5ui5_cl_util=>rtti_get_t_attri_by_struc( tab ).
    DATA(tab_name) = z5ui5_cl_util=>rtti_tab_get_relative_name( tab ).
...
* Default ony 10 rows
  ...
  METHOD render_delete.
    ...
    DATA(popup) = z5ui5_cl_xml_view=>factory_popup(  ).
...
*                headertext = 'Layout'
  ...
  METHOD render_edit.
    ...
    DATA(lt_comp) = z5ui5_cl_util=>rtti_get_t_attri_by_struc( ms_layout-t_layout ).
...
*    form->toolbar( )->title( 'Layout' ).
  ...
  METHOD save_layout.
    ...
    DATA t002 TYPE STANDARD TABLE OF z5ui5_t002 WITH EMPTY KEY.
    ...
    DATA(t001) = VALUE z5ui5_t001(      layout  = mv_layout
    ...
    SELECT SINGLE layout FROM z5ui5_t001
...
* postionen lesen und loeschen
      ...
      IF sy-subrc = 0.
        DELETE z5ui5_t002 FROM TABLE @del.
        COMMIT WORK AND WAIT.
      ENDIF.

    ENDIF.

    MODIFY z5ui5_t001 FROM @t001.
    IF sy-subrc = 0.

      MODIFY z5ui5_t002 FROM TABLE @t002.
  ...
  METHOD z5ui5_if_app~main.
    ...
    IF client->get( )-check_on_navigated = abap_true.
      ...
      TRY.
          DATA(app) = CAST z5ui5_cl_popup_layout( client->get_app( client->get( )-s_draft-id_prev_app ) ).
