CLASS z3ui5_cl_popup_file_upload DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)       TYPE REF TO z3ui5_cl_popup_file_upload.
...
CLASS z3ui5_cl_popup_file_upload IMPLEMENTATION.
  ...
  METHOD z3ui5_if_app~main.
    ...
    CASE client->get( )-event.
      ...
      WHEN `UPLOAD`.
        ...
        DATA(lv_data2) = z3ui5_cl_util=>conv_decode_x_base64( lv_data ).
        ms_result-value = z3ui5_cl_util=>conv_get_string_by_xstring( lv_data2 ).
