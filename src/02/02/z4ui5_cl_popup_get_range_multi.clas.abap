CLASS z4ui5_cl_popup_get_range_multi DEFINITION
  PUBLIC FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    TYPES:
      BEGIN OF ty_s_variant_out,
        ...
        t_filter      TYPE z4ui5_cl_util=>ty_t_filter_multi,
    ...
    CLASS-METHODS factory
      IMPORTING
        val             TYPE z4ui5_cl_util=>ty_t_filter_multi
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO z4ui5_cl_popup_get_range_multi.

    TYPES:
      BEGIN OF ty_s_result,
        t_sql           TYPE z4ui5_cl_util=>ty_t_filter_multi,
...
CLASS z4ui5_cl_popup_get_range_multi IMPLEMENTATION.
  ...
  METHOD db_read.
    TRY.
        ...
        z4ui5_cl_util=>db_load_by_handle(
            EXPORTING
  ...
  METHOD popup_display.
    ...
    DATA(lo_popup) = z4ui5_cl_xml_view=>factory_popup( ).
...
*        )->toolbar_spacer(
  ...
  METHOD z4ui5_if_app~main.
    ...
    IF client->get( )-check_on_navigated = abap_true.
      ...
      DATA(lo_popup) = CAST z4ui5_cl_popup_get_range( client->get_app( client->get( )-s_draft-id_prev_app ) ).
      IF lo_popup->result( )-check_confirmed = abap_true.
        ...
        <tab>-t_token = z4ui5_cl_util=>filter_get_token_t_by_range_t( <tab>-t_range ).
      ENDIF.
      popup_display( ).
    ...
    CASE client->get( )-event.
      ...
      WHEN 'LIST_OPEN'.
        ...
        client->nav_app_call( z4ui5_cl_popup_get_range=>factory( ls_sql-t_range ) ).
