CLASS z5ui5_cl_popup_js_loader DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result) TYPE REF TO z5ui5_cl_popup_js_loader.
...
CLASS z5ui5_cl_popup_js_loader IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    DATA(popup) = z5ui5_cl_xml_view=>factory_popup( )->dialog( `Setup UI...`
        )->content( ).
