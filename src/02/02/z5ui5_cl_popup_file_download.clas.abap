CLASS z5ui5_cl_popup_file_download DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)       TYPE REF TO z5ui5_cl_popup_file_download.
...
CLASS z5ui5_cl_popup_file_download IMPLEMENTATION.
  ...
  METHOD view_display.
    ...
    DATA(popup) = z5ui5_cl_xml_view=>factory_popup( )->dialog(
                  title       = title
                  icon        = icon
    ...
    IF mv_check_download = abap_true.
      data(lv_csv_x) = z5ui5_cl_util=>conv_get_xstring_by_string( mv_value ).
      DATA(lv_base64) = z5ui5_cl_util=>conv_encode_x_base64( lv_csv_x ).
