CLASS z4ui5_cl_popup_get_range DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      IMPORTING
        t_range         TYPE z4ui5_cl_util=>ty_t_range  OPTIONAL
      RETURNING
        VALUE(r_result) TYPE REF TO z4ui5_cl_popup_get_range.

    TYPES:
      BEGIN OF ty_s_result,
        t_range         TYPE z4ui5_cl_util=>ty_t_range,
    ...
    DATA mt_mapping TYPE z4ui5_if_types=>ty_t_name_value.
  PROTECTED SECTION.
...
CLASS z4ui5_cl_popup_get_range IMPLEMENTATION.
...
*      )->end_button(
  ...
  METHOD z4ui5_if_app~main.
    ...
    IF check_initialized = abap_false.
      ...
      mt_mapping = z4ui5_cl_util=>filter_get_token_range_mapping( ).
      ...
      LOOP AT ms_result-t_range REFERENCE INTO DATA(lr_product).
        INSERT VALUE #(
                 ...
                 key    = z4ui5_cl_util=>uuid_get_c32( )
    ...
    CASE client->get( )-event.
      ...
      WHEN `POPUP_ADD`.
        INSERT VALUE #( key = z4ui5_cl_util=>uuid_get_c32( ) ) INTO TABLE mt_filter.
