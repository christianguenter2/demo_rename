CLASS z3ui5_cl_popup_layout DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(result)    TYPE REF TO z3ui5_cl_popup_layout.
...
CLASS z3ui5_cl_popup_layout IMPLEMENTATION.
  ...
  METHOD db_delete_layout.
    ...
    DELETE  z3ui5_t001 FROM @layout-s_head.
    DELETE  z3ui5_t002 FROM TABLE @layout-t_layout.
  ...
  METHOD init_layout.
    ...
    DATA(t_comp)   = z3ui5_cl_util=>rtti_get_t_attri_by_struc( tab ).
    DATA(tab_name) = z3ui5_cl_util=>rtti_tab_get_relative_name( tab ).
...
*                headertext = 'Layout'
  ...
  METHOD render_edit.
    ...
    DATA(lt_comp) = z3ui5_cl_util=>rtti_get_t_attri_by_struc( ms_layout-t_layout ).
...
*    form->toolbar( )->title( 'Layout' ).
  ...
  METHOD save_layout.
    ...
    DATA t002 TYPE STANDARD TABLE OF z3ui5_t002 WITH EMPTY KEY.
    ...
    DATA(t001) = VALUE z3ui5_t001(      layout  = mv_layout
    ...
    SELECT SINGLE layout FROM z3ui5_t001
...
* postionen lesen und loeschen
      ...
      IF sy-subrc = 0.
        DELETE z3ui5_t002 FROM TABLE @del.
        COMMIT WORK AND WAIT.
      ENDIF.

    ENDIF.

    MODIFY z3ui5_t001 FROM @t001.
    IF sy-subrc = 0.

      MODIFY z3ui5_t002 FROM TABLE @t002.
