CLASS z4ui5_cl_popup_itab_json_dl DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(r_result)       TYPE REF TO z4ui5_cl_popup_itab_json_dl.
...
CLASS z4ui5_cl_popup_itab_json_dl IMPLEMENTATION.


  METHOD factory.

    r_result = NEW #( ).
    r_result->mr_itab = z4ui5_cl_util=>conv_copy_ref_data( itab ).
  ...
  METHOD z4ui5_if_app~main.
    ...
    TRY.
        ...
        IF z4ui5_cl_util=>rtti_check_class_exists( `z2ui5_dbt_cl_app_03` ) = abap_false.
          ...
          DATA(lx) = NEW z4ui5_cx_util_error( val = lv_text ).
          client->nav_app_leave( z4ui5_cl_popup_error=>factory( lx ) ).
      ...
      CATCH cx_root INTO DATA(x).
        client->nav_app_leave( z4ui5_cl_popup_to_inform=>factory( x->get_text( ) ) ).
    ENDTRY.
  ENDMETHOD.
ENDCLASS.
