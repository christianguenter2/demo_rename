CLASS z3ui5_cl_xml_view DEFINITION
  PUBLIC
  FINAL
  CREATE PROTECTED .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      IMPORTING
        !t_ns         TYPE z3ui5_if_types=>ty_t_name_value OPTIONAL
      RETURNING
        VALUE(result) TYPE REF TO z3ui5_cl_xml_view.
    ...
    METHODS _generic
      IMPORTING
        !name         TYPE clike
        !ns           TYPE clike OPTIONAL
        !t_prop       TYPE z3ui5_if_types=>ty_t_name_value OPTIONAL
      RETURNING
        VALUE(result) TYPE REF TO z3ui5_cl_xml_view .
    METHODS _generic_property
      IMPORTING
        !val          TYPE z3ui5_if_types=>ty_s_name_value OPTIONAL
      RETURNING
        VALUE(result) TYPE REF TO z3ui5_cl_xml_view .
    METHODS xml_get
      RETURNING
    ...
    METHODS _z2ui5
      RETURNING
        VALUE(result) TYPE REF TO z3ui5_cl_xml_view_cc .
 ...
 methods column_menu_quick_total_item
  ...
  PROTECTED SECTION.
    ...
    DATA mt_prop  TYPE SORTED TABLE OF z3ui5_if_types=>ty_s_name_value WITH NON-UNIQUE KEY n.

    DATA mt_ns  TYPE SORTED TABLE OF string WITH UNIQUE KEY table_line.
    DATA mo_root   TYPE REF TO z3ui5_cl_xml_view.
    DATA mo_previous   TYPE REF TO z3ui5_cl_xml_view.
    DATA mo_parent TYPE REF TO z3ui5_cl_xml_view.
    DATA mt_child  TYPE STANDARD TABLE OF REF TO z3ui5_cl_xml_view WITH EMPTY KEY.
...
CLASS z3ui5_cl_xml_view IMPLEMENTATION.
  ...
  METHOD action_button.
    result = _generic( name   = `ActionButton`
                       ...
                       t_prop = VALUE #(
                             ...
                             ( n = `title`    v = title )
                             ( n = `press`    v = press )
                             ( n = `enabled`  v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                         ) ).
  ENDMETHOD.
  ...
  METHOD action_sheet.
    result = _generic( name   = `ActionSheet`
                       t_prop = VALUE #(
                             ...
                             ( n = `visible`           v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                         ) ).
  ENDMETHOD.
  ...
  METHOD area_micro_chart.
    ...
    _generic( name   = `AreaMicroChart`
              ...
              t_prop = VALUE #( ( n = `colorPalette`  v = colorpalette )
                                ...
                                ( n = `hideOnNoData`    v = z3ui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `showLabel`    v = z3ui5_cl_util=>boolean_abap_2_json( showlabel ) )
                                ( n = `width`  v = width ) ) ).
  ENDMETHOD.
  ...
  METHOD avatar.
    ...
    _generic( name   = `Avatar`
              t_prop = VALUE #( ( n = `src`         v = src )
                                ...
                                ( n = `showBorder`       v = z3ui5_cl_util=>boolean_abap_2_json( showborder ) )
                                ( n = `decorative`       v = z3ui5_cl_util=>boolean_abap_2_json( decorative ) )
                                ( n = `enabled`       v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
  ...
  METHOD base_rectangle.
    ...
    result = _generic( name   = `BaseRectangle`
                       ...
                       t_prop = VALUE #( ( n = `time`                      v = time )
                                         ( n = `endTime`                   v = endtime )
                                         ( n = `selectable`                v = z3ui5_cl_util=>boolean_abap_2_json( selectable ) )
                                         ...
                                         ( n = `connectable`               v = z3ui5_cl_util=>boolean_abap_2_json( connectable ) )
                                         ( n = `fontFamily`                v = fontfamily )
                                         ( n = `filter`                    v = filter )
                                         ( n = `transform`                 v = transform )
                                         ( n = `countInBirdEye`            v = z3ui5_cl_util=>boolean_abap_2_json( countinbirdeye ) )
                                         ( n = `fontWeight`                v = fontweight )
                                         ( n = `showTitle`                 v = z3ui5_cl_util=>boolean_abap_2_json( showtitle ) )
                                         ( n = `selected`                  v = z3ui5_cl_util=>boolean_abap_2_json( selected ) )
                                         ( n = `resizable`                 v = z3ui5_cl_util=>boolean_abap_2_json( resizable ) )
                                         ( n = `horizontalTextAlignment`   v = horizontaltextalignment )
                                         ( n = `shapeId`                   v = shapeid )
                                         ( n = `highlighted`               v = z3ui5_cl_util=>boolean_abap_2_json( highlighted ) )
                                         ( n = `highlightable`             v = z3ui5_cl_util=>boolean_abap_2_json( highlightable ) ) ) ).
  ENDMETHOD.
  ...
  METHOD bullet_micro_chart.
    ...
    _generic( name   = `BulletMicroChart`
              ...
              t_prop = VALUE #( ( n = `actualValueLabel`  v = actualvaluelabel )
                                ...
                                ( n = `hideOnNoData`    v = z3ui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `showActualValue`    v = z3ui5_cl_util=>boolean_abap_2_json( showactualvalue ) )
                                ( n = `showActualValueInDeltaMode`    v = z3ui5_cl_util=>boolean_abap_2_json( savidm ) )
                                ( n = `showDeltaValue`    v = z3ui5_cl_util=>boolean_abap_2_json( showdeltavalue ) )
                                ( n = `showTargetValue`    v = z3ui5_cl_util=>boolean_abap_2_json( showtargetvalue ) )
                                ( n = `showThresholds`    v = z3ui5_cl_util=>boolean_abap_2_json( showthresholds ) )
                                ( n = `showValueMarker`    v = z3ui5_cl_util=>boolean_abap_2_json( showvaluemarker ) )
                                ( n = `smallRangeAllowed`    v = z3ui5_cl_util=>boolean_abap_2_json( smallrangeallowed ) )
  ...
  METHOD busy_indicator.
    result = _generic( name = `BusyIndicator`
                   t_prop   = VALUE #(
                         ...
                         ( n = `customIconDensityAware`           v = z3ui5_cl_util=>boolean_abap_2_json( customicondensityaware ) )
                         ( n = `visible`           v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                     ) ).
  ENDMETHOD.
  ...
  METHOD button.
    ...
    _generic( name   = `Button`
              ...
              t_prop = VALUE #( ( n = `press`   v = press )
                                ...
                                ( n = `enabled` v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `visible` v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `iconDensityAware` v = z3ui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                                ( n = `iconFirst` v = z3ui5_cl_util=>boolean_abap_2_json( iconfirst ) )
                                ( n = `icon`    v = icon )
                                ( n = `type`    v = type )
                                ( n = `id`      v = id )
                                ( n = `width`   v = width )
  ...
  METHOD card_header.
    result = _generic( name = `Header`
                   ...
                   t_prop   = VALUE #(
                         ...
                         ( n = `iconVisible`  v = z3ui5_cl_util=>boolean_abap_2_json( iconvisible ) )
                         ( n = `visible`    v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                     ) ).
  ENDMETHOD.
  ...
  METHOD carousel.
    ...
    result = _generic( name   = `Carousel`
                       t_prop = VALUE #( ( n = `loop`  v = z3ui5_cl_util=>boolean_abap_2_json( loop ) )
                                         ( n = `class`  v = class )
                                         ( n = `height`  v = height )
                                         ( n = `id`  v = id )
  ...
  METHOD checkbox.
    ...
    _generic( name   = `CheckBox`
              t_prop = VALUE #( ( n = `text`     v = text )
                                ...
                                ( n = `width` v = width )
                                ( n = `activeHandling`  v = z3ui5_cl_util=>boolean_abap_2_json( activehandling ) )
                                ( n = `enabled`  v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `visible`  v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `displayOnly`  v = z3ui5_cl_util=>boolean_abap_2_json( displayonly ) )
                                ( n = `editable`  v = z3ui5_cl_util=>boolean_abap_2_json( editable ) )
                                ( n = `partiallySelected`  v = z3ui5_cl_util=>boolean_abap_2_json( partiallyselected ) )
                                ( n = `useEntireWidth`  v = z3ui5_cl_util=>boolean_abap_2_json( useentirewidth ) )
                                ( n = `wrapping`  v = z3ui5_cl_util=>boolean_abap_2_json( wrapping ) )
                                ( n = `select`   v = select ) ) ).
  ENDMETHOD.
  ...
  METHOD column.
    result = _generic( name   = `Column`
                       t_prop = VALUE #( ( n = `width` v = width )
                                         ...
                                         ( n = `id`         v = id )
                                         ( n = `class`         v = class )
                                         ( n = `mergeDuplicates` v = z3ui5_cl_util=>boolean_abap_2_json( mergeduplicates ) )
                                         ( n = `visible` v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `demandPopin` v = z3ui5_cl_util=>boolean_abap_2_json( demandpopin ) ) ) ).
  ENDMETHOD.
  ...
  METHOD column_list_item.
    result = _generic( name   = `ColumnListItem`
                       t_prop = VALUE #( ( n = `vAlign`   v = valign )
                                         ( n = `id` v = id )
                                         ( n = `selected` v = z3ui5_cl_util=>boolean_abap_2_json( selected ) )
                                         ( n = `unread` v = z3ui5_cl_util=>boolean_abap_2_json( unread ) )
                                         ( n = `visible` v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `type`     v = type )
                                         ( n = `counter`     v = counter )
                                         ...
                                         ( n = `navigated`     v = z3ui5_cl_util=>boolean_abap_2_json( navigated ) )
                                         ( n = `press`    v = press ) ) ).
  ENDMETHOD.
  ...
  METHOD column_menu_item.
    result = _generic( name   = `Item`
                       ...
                       t_prop = VALUE #(
                             ...
                             ( n = `confirm`    v = confirm )
                             ( n = `reset`    v = reset )
                             ( n = `resetButtonEnabled`  v = z3ui5_cl_util=>boolean_abap_2_json( resetButtonEnabled ) )
                             ( n = `showCancelButton`  v = z3ui5_cl_util=>boolean_abap_2_json( showCancelButton ) )
                             ( n = `showConfirmButton`  v = z3ui5_cl_util=>boolean_abap_2_json( showConfirmButton ) )
                             ( n = `showResetButton`  v = z3ui5_cl_util=>boolean_abap_2_json( showResetButton ) )
                             ( n = `visible`  v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                         ) ).
  ENDMETHOD.
  ...
  METHOD column_menu_quick_group_item.
    result = _generic( name   = `QuickGroupItem`
                       ...
                       t_prop = VALUE #(
                             ...
                             ( n = `key`    v = key )
                             ( n = `label`    v = label )
                             ( n = `grouped`  v = z3ui5_cl_util=>boolean_abap_2_json( grouped ) )
                             ( n = `visible`  v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                         ) ).
  ENDMETHOD.
  ...
  METHOD column_menu_quick_total_item.
    result = _generic( name   = `QuickTotalItem`
                       ...
                       t_prop = VALUE #(
                             ...
                             ( n = `key`    v = key )
                             ( n = `label`    v = label )
                             ( n = `totaled`  v = z3ui5_cl_util=>boolean_abap_2_json( totaled ) )
                             ( n = `visible`  v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                         ) ).
  ENDMETHOD.
  ...
  METHOD column_micro_chart.
    ...
    _generic( name   = `ColumnMicroChart`
              ...
              t_prop = VALUE #( ( n = `width`  v = width )
                                ...
                                ( n = `alignContent`      v = aligncontent )
                                ( n = `hideOnNoData`    v = z3ui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `allowColumnLabels`    v = z3ui5_cl_util=>boolean_abap_2_json( allowcolumnlabels ) )
                                ( n = `showBottomLabels`    v = z3ui5_cl_util=>boolean_abap_2_json( showbottomlabels ) )
                                ( n = `showTopLabels`    v = z3ui5_cl_util=>boolean_abap_2_json( showtoplabels ) )
                                ( n = `height`  v = height ) ) ).
  ENDMETHOD.
  ...
  METHOD combobox.
    result = _generic( name   = `ComboBox`
                       t_prop = VALUE #( (  n = `showClearIcon` v = z3ui5_cl_util=>boolean_abap_2_json( showclearicon ) )
                                         ...
                                         (  n = `textAlign`         v = textalign )
                                         (  n = `showSecondaryValues`         v = z3ui5_cl_util=>boolean_abap_2_json( showsecondaryvalues ) )
                                         (  n = `visible`         v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         (  n = `showValueStateMessage`         v = z3ui5_cl_util=>boolean_abap_2_json( showvaluestatemessage ) )
                                         (  n = `showButton`         v = z3ui5_cl_util=>boolean_abap_2_json( showbutton ) )
                                         (  n = `required`         v = z3ui5_cl_util=>boolean_abap_2_json( required ) )
                                         (  n = `editable`         v = z3ui5_cl_util=>boolean_abap_2_json( editable ) )
                                         (  n = `enabled`         v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                         (  n = `filterSecondaryValues`         v = z3ui5_cl_util=>boolean_abap_2_json( filtersecondaryvalues ) )
                                         (  n = `width`         v = width )
  ...
  METHOD comparison_micro_chart.
    ...
    _generic( name   = `ComparisonMicroChart`
              ...
              t_prop = VALUE #( ( n = `colorPalette`  v = colorpalette )
                                ...
                                ( n = `width`      v = width )
                                ( n = `hideOnNoData`    v = z3ui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `shrinkable`    v = z3ui5_cl_util=>boolean_abap_2_json( shrinkable ) )
                                ( n = `view`  v = view ) ) ).
  ENDMETHOD.
  ...
  METHOD container_toolbar.
    ...
    result = _generic( name   = `ContainerToolbar`
                       ...
                       t_prop = VALUE #( ( n = `showSearchButton`          v = showsearchbutton )
                                         ( n = `alignCustomContentToRight` v = z3ui5_cl_util=>boolean_abap_2_json( aligncustomcontenttoright ) )
                                         ( n = `findMode`                  v = findmode )
                                         ( n = `infoOfSelectItems`         v = infoofselectitems )
                                         ( n = `findbuttonpress`           v = findbuttonpress )
                                         ( n = `showBirdEyeButton`         v = z3ui5_cl_util=>boolean_abap_2_json( showbirdeyebutton ) )
                                         ( n = `showDisplayTypeButton`     v = z3ui5_cl_util=>boolean_abap_2_json( showdisplaytypebutton ) )
                                         ( n = `showLegendButton`          v = z3ui5_cl_util=>boolean_abap_2_json( showlegendbutton ) )
                                         ( n = `showSettingButton`         v = z3ui5_cl_util=>boolean_abap_2_json( showsettingbutton ) )
                                         ( n = `showTimeZoomControl`       v = z3ui5_cl_util=>boolean_abap_2_json( showtimezoomcontrol ) )
  ...
  METHOD date_picker.
    ...
    _generic( name   = `DatePicker`
              t_prop = VALUE #( ( n = `value`                 v = value )
                                ...
                                ( n = `visible`               v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `editable`              v = z3ui5_cl_util=>boolean_abap_2_json( editable ) )
                                ( n = `hideInput`             v = z3ui5_cl_util=>boolean_abap_2_json( hideinput ) )
                                ( n = `showFooter`            v = z3ui5_cl_util=>boolean_abap_2_json( showfooter ) )
                                ( n = `showValueStateMessage` v = z3ui5_cl_util=>boolean_abap_2_json( showvaluestatemessage ) )
                                ( n = `showCurrentDateButton` v = z3ui5_cl_util=>boolean_abap_2_json( showcurrentdatebutton ) ) ) ).
  ENDMETHOD.
  ...
  METHOD dialog.
    ...
    result = _generic( name   = `Dialog`
                       t_prop = VALUE #( ( n = `title`  v = title )
                                         ...
                                         ( n = `closeOnNavigation`  v = z3ui5_cl_util=>boolean_abap_2_json( closeonnavigation ) )
                                         ( n = `draggable`  v = z3ui5_cl_util=>boolean_abap_2_json( draggable ) )
                                         ( n = `resizable`  v = z3ui5_cl_util=>boolean_abap_2_json( resizable ) )
                                         ( n = `horizontalScrolling`  v = z3ui5_cl_util=>boolean_abap_2_json( horizontalscrolling ) )
                                         ( n = `verticalScrolling`  v = z3ui5_cl_util=>boolean_abap_2_json( verticalscrolling ) )
                                         ( n = `afterOpen`  v = afteropen )
                                         ( n = `beforeClose`  v = beforeclose )
                                         ( n = `beforeOpen`  v = beforeopen )
                                         ( n = `afterClose` v = afterclose ) ) ).
  ...
  METHOD dynamic_page.
    result = _generic( name   = `DynamicPage`
                       ns     = `f`
                       t_prop = VALUE #(
                           (  n = `headerExpanded`           v = z3ui5_cl_util=>boolean_abap_2_json( headerexpanded ) )
                           (  n = `headerPinned`           v = z3ui5_cl_util=>boolean_abap_2_json( headerpinned ) )
                           (  n = `showFooter`           v = z3ui5_cl_util=>boolean_abap_2_json( showfooter ) )
  ...
  METHOD dynamic_page_header.
    result = _generic(
                 ...
                 ns     = `f`
                 t_prop = VALUE #( (  n = `pinnable`           v = z3ui5_cl_util=>boolean_abap_2_json( pinnable ) ) ) ).
  ENDMETHOD.
  ...
  METHOD expandable_text.
    result = _generic( name   = `ExpandableText`
                       t_prop = VALUE #(
                             ...
                             ( n = `renderWhitespace`             v = z3ui5_cl_util=>boolean_abap_2_json( renderwhitespace ) )
                             ( n = `text`        v = text )
                             ( n = `textAlign`         v = textalign )
                             ( n = `textDirection`       v = textdirection )
  ...
  METHOD facet_filter.
    result = _generic( name   = `FacetFilter`
                       t_prop = VALUE #(
                             ( n = `id`  v = id )
                             ( n = `class`  v = class )
                             ( n = `liveSearch`  v = z3ui5_cl_util=>boolean_abap_2_json( livesearch ) )
                             ( n = `showPersonalization` v = z3ui5_cl_util=>boolean_abap_2_json( showpersonalization ) )
                             ( n = `showPopoverOKButton`  v = z3ui5_cl_util=>boolean_abap_2_json( showpopoverokbutton ) )
                             ( n = `showReset`             v = z3ui5_cl_util=>boolean_abap_2_json( showreset ) )
                             ( n = `showSummaryBar`        v = z3ui5_cl_util=>boolean_abap_2_json( showsummarybar ) )
                             ( n = `type`         v = type )
                             ( n = `confirm`        v = confirm )
                             ( n = `reset` v = reset )
                             ( n = `lists` v = lists )
  ...
  METHOD facet_filter_list.
    result = _generic( name   = `FacetFilterList`
                       t_prop = VALUE #(
                             ( n = `id`  v = id )
                             ( n = `class`  v = class )
                             ( n = `active`  v = z3ui5_cl_util=>boolean_abap_2_json( active ) )
                             ( n = `allCount`  v = allcount )
                             ( n = `backgroundDesign`         v = backgrounddesign )
                             ( n = `dataType`  v = datatype )
                             ( n = `enableBusyIndicator` v = z3ui5_cl_util=>boolean_abap_2_json( enablebusyindicator ) )
                             ( n = `enableCaseInsensitiveSearch` v = z3ui5_cl_util=>boolean_abap_2_json( enablecaseinsensitivesearch ) )
                             ( n = `footerText`         v = footertext )
                             ( n = `growing`       v = z3ui5_cl_util=>boolean_abap_2_json( growing ) )
                             ( n = `growingDirection`        v = growingdirection )
                             ( n = `growingScrollToLoad` v = z3ui5_cl_util=>boolean_abap_2_json( growingscrolltoload ) )
                             ( n = `growingThreshold` v = growingthreshold )
                             ( n = `growingTriggerText` v = growingtriggertext )
                             ( n = `headerLevel` v = headerlevel )
                             ( n = `includeItemInSelection` v = z3ui5_cl_util=>boolean_abap_2_json( includeiteminselection ) )
                             ( n = `inset` v = z3ui5_cl_util=>boolean_abap_2_json( inset ) )
                             ( n = `key` v = key )
                             ( n = `swipedirection` v = swipedirection )
                             ( n = `headerText` v = headertext )
                             ( n = `keyboardMode` v = keyboardmode )
                             ( n = `mode` v = mode )
                             ( n = `modeAnimationOn` v = z3ui5_cl_util=>boolean_abap_2_json( modeanimationon ) )
                             ( n = `multiSelectMode` v = multiselectmode )
                             ( n = `noDataText` v = nodatatext )
                             ( n = `rememberSelections` v = z3ui5_cl_util=>boolean_abap_2_json( rememberselections ) )
                             ( n = `retainListSequence` v = z3ui5_cl_util=>boolean_abap_2_json( retainlistsequence ) )
                             ( n = `sequence` v = sequence )
                             ( n = `showNoData` v = z3ui5_cl_util=>boolean_abap_2_json( shownodata ) )
                             ( n = `showRemoveFacetIcon` v = z3ui5_cl_util=>boolean_abap_2_json( showremovefaceticon ) )
                             ( n = `showSeparators` v = showseparators )
                             ( n = `showUnread` v = z3ui5_cl_util=>boolean_abap_2_json( showunread ) )
                             ( n = `sticky` v = sticky )
                             ( n = `title` v = title )
                             ( n = `width` v = width )
                             ( n = `wordWrap` v = z3ui5_cl_util=>boolean_abap_2_json( wordwrap ) )
  ...
  METHOD feed_input.
    result = _generic( name   = `FeedInput`
                       t_prop = VALUE #( ( n = `buttonTooltip`    v = buttontooltip )
                                         ...
                                         ( n = `placeholder`      v = placeholder )
                                         ( n = `rows`             v = rows )
                                         ( n = `showExceededText` v = z3ui5_cl_util=>boolean_abap_2_json( showexceededtext ) )
                                         ( n = `showIcon`         v = z3ui5_cl_util=>boolean_abap_2_json( showicon ) )
                                         ( n = `value`            v = value )
                                         ( n = `class`            v = class )
                                         ( n = `post`             v = post ) ) ).
  ...
  METHOD feed_list_item.
    result = _generic( name   = `FeedListItem`
                       t_prop = VALUE #( ( n = `activeIcon`                  v = activeicon )
                                         ...
                                         ( n = `iconActive`                  v = z3ui5_cl_util=>boolean_abap_2_json( iconactive ) )
                                         ( n = `icon`                        v = icon )
                                         ( n = `iconDensityAware`            v = z3ui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                                         ( n = `iconDisplayShape`            v = icondisplayshape )
                                         ( n = `iconInitials`                v = iconinitials )
                                         ...
                                         ( n = `sender`                      v = sender )
                                         ( n = `senderActive`                v = z3ui5_cl_util=>boolean_abap_2_json( senderactive ) )
                                         ( n = `showIcon`                    v = z3ui5_cl_util=>boolean_abap_2_json( showicon ) )
                                         ( n = `text`                        v = text )
  ...
  METHOD feed_list_item_action.
    result = _generic( name    = `FeedListItemAction`
                        t_prop = VALUE #( ( n = `enabled` v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                          ( n = `icon`    v = icon )
                                          ( n = `key`     v = key )
                                          ( n = `text`    v = text )
                                          ( n = `press`   v = press )
  ...
  METHOD filter_bar.
    ...
    result = _generic( name   = `FilterBar`
                       ns     = 'fb'
                       t_prop = VALUE #( ( n = 'useToolbar'     v = z3ui5_cl_util=>boolean_abap_2_json( usetoolbar ) )
                                         ( n = 'search'         v = search )
                                         ( n = 'id'             v = id )
                                         ...
                                         ( n = 'header' v = header )
                                         ( n = 'advancedMode' v = z3ui5_cl_util=>boolean_abap_2_json( advancedmode ) )
                                         ( n = 'isRunningInValueHelpDialog' v = z3ui5_cl_util=>boolean_abap_2_json( isrunninginvaluehelpdialog ) )
                                         ( n = 'showAllFilters' v = z3ui5_cl_util=>boolean_abap_2_json( showallfilters ) )
                                         ( n = 'showClearOnFB' v = z3ui5_cl_util=>boolean_abap_2_json( showclearonfb ) )
                                         ( n = 'showFilterConfiguration' v = z3ui5_cl_util=>boolean_abap_2_json( showfilterconfiguration ) )
                                         ( n = 'showGoOnFB' v = z3ui5_cl_util=>boolean_abap_2_json( showgoonfb ) )
                                         ( n = 'showRestoreButton' v = z3ui5_cl_util=>boolean_abap_2_json( showrestorebutton ) )
                                         ( n = 'showRestoreOnFB' v = z3ui5_cl_util=>boolean_abap_2_json( showrestoreonfb ) )
                                         ( n = 'useSnapshot' v = z3ui5_cl_util=>boolean_abap_2_json( usesnapshot ) )
                                         ( n = 'searchEnabled' v = z3ui5_cl_util=>boolean_abap_2_json( searchenabled ) )
                                         ( n = 'considerGroupTitle' v = z3ui5_cl_util=>boolean_abap_2_json( considergrouptitle ) )
                                         ( n = 'deltaVariantMode' v = z3ui5_cl_util=>boolean_abap_2_json( deltavariantmode ) )
                                         ( n = 'disableSearchMatchesPatternWarning' v = z3ui5_cl_util=>boolean_abap_2_json( disablesearchmatchespatternw ) )
                                         ( n = 'filterBarExpanded' v = z3ui5_cl_util=>boolean_abap_2_json( filterbarexpanded ) )
  ...
  METHOD flexible_column_layout.
    ...
    result = _generic( name   = `FlexibleColumnLayout`
                       ...
                       t_prop = VALUE #(
                        ...
                        (  n = `autoFocus` v = z3ui5_cl_util=>boolean_abap_2_json( autofocus ) )
                        (  n = `restoreFocusOnBackNavigation` v = z3ui5_cl_util=>boolean_abap_2_json( restorefocusonbacknavigation ) )
                        ) ).
  ...
  METHOD flex_box.
    result = _generic( name   = `FlexBox`
                       t_prop = VALUE #( ( n = `class`  v = class )
                                         ...
                                         ( n = `fitContainer`  v = z3ui5_cl_util=>boolean_abap_2_json( fitcontainer ) )
                                         ( n = `justifyContent`  v = justifycontent )
                                         ( n = `wrap`  v = wrap )
                                         ( n = `direction`  v = direction )
                                         ( n = `alignContent`  v = aligncontent )
                                         ( n = `backgroundDesign`  v = backgrounddesign )
                                         ( n = `displayInline`  v = z3ui5_cl_util=>boolean_abap_2_json( displayinline ) )
                                         ( n = `visible`  v = visible ) ) ).
  ENDMETHOD.
  ...
  METHOD gantt_chart_with_table.
    result = _generic( name   = `GanttChartWithTable`
                       ...
                       t_prop = VALUE #( ( n = `id` v = id )
                                         ...
                                         ( n = `isConnectorDetailsVisible` v = z3ui5_cl_util=>boolean_abap_2_json( isconnectordetailsvisible ) )
                                          ) ).
  ENDMETHOD.
  ...
  METHOD generic_tile.
    ...
    _generic(
      ...
      t_prop = VALUE #(
                ...
                ( n = `visible`  v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                ( n = `renderOnThemeChange`  v = z3ui5_cl_util=>boolean_abap_2_json( renderonthemechange ) )
                ( n = `enableNavigationButton`  v = z3ui5_cl_util=>boolean_abap_2_json( enablenavigationbutton ) )
                ( n = `pressEnabled`  v = z3ui5_cl_util=>boolean_abap_2_json( pressenabled ) )
                ( n = `iconLoaded`  v = z3ui5_cl_util=>boolean_abap_2_json( iconloaded ) )
  ...
  METHOD group.
    result = _generic( name = `group`
                       ns   = `networkgraph`
                       t_prop = VALUE #( ( n = `collapsed`  v = z3ui5_cl_util=>boolean_abap_2_json( collapsed ) )
                                         ( n = `id`       v = id )
                                         ( n = `class`       v = class )
  ...
  METHOD harvey_ball_micro_chart.
    ...
    _generic( name   = `HarveyBallMicroChart`
              ...
              t_prop = VALUE #( ( n = `colorPalette`  v = colorpalette )
                                ...
                                ( n = `alignContent`      v = aligncontent )
                                ( n = `hideOnNoData`    v = z3ui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `formattedLabel`    v = z3ui5_cl_util=>boolean_abap_2_json( formattedlabel ) )
                                ( n = `showFractions`    v = z3ui5_cl_util=>boolean_abap_2_json( showfractions ) )
                                ( n = `showTotal`    v = z3ui5_cl_util=>boolean_abap_2_json( showtotal ) )
  ...
  METHOD header_container_control.
    result = _generic( name   = `HeaderContainer`
                       t_prop = VALUE #( ( n = `backgroundDesign` v = backgrounddesign )
                                         ( n = `gridLayout` v = z3ui5_cl_util=>boolean_abap_2_json( gridlayout ) )
                                         ( n = `height` v = height )
                                         ( n = `orientation` v = orientation )
                                         ( n = `scrollStep` v = scrollstep )
                                         ( n = `scrollStepByItem` v = scrollstepbyitem )
                                         ( n = `scrollTime` v = scrolltime )
                                         ( n = `showDividers` v = z3ui5_cl_util=>boolean_abap_2_json( showdividers ) )
                                         ( n = `showOverflowItem` v = z3ui5_cl_util=>boolean_abap_2_json( showoverflowitem ) )
                                         ( n = `visible` v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `width` v = width )
                                         ( n = `id` v = id )
                                         ( n = `scroll` v = scroll )
  ...
  METHOD horizontal_layout.
    result = _generic( name   = `HorizontalLayout`
                       ns     = `layout`
                       t_prop = VALUE #( ( n = `class`  v = class )
                                         ( n = `allowWrapping`  v = z3ui5_cl_util=>boolean_abap_2_json( allowwrapping ) )
                                         ( n = `id`  v = id )
                                         ( n = `visible`  v = visible ) ) ).
  ENDMETHOD.
  ...
  METHOD html.
    ...
    result = _generic( name   = `HTML`
                       ...
                       t_prop = VALUE #(
                          ...
                          ( n = 'preferDOM' v = z3ui5_cl_util=>boolean_abap_2_json( preferdom ) )
                          ( n = 'sanitizeContent' v = z3ui5_cl_util=>boolean_abap_2_json( sanitizecontent ) )
                          ( n = 'visible' v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                          ) ).
  ...
  METHOD icon.
    ...
    _generic( name   = `Icon`
              ...
              t_prop = VALUE #( ( n = `size`  v = size )
                                ...
                                ( n = `visible`  v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `decorative`  v = z3ui5_cl_util=>boolean_abap_2_json( decorative ) )
                                ( n = `noTabStop`  v = z3ui5_cl_util=>boolean_abap_2_json( notabstop ) )
                                ( n = `useIconTooltip`  v = z3ui5_cl_util=>boolean_abap_2_json( useicontooltip ) )
                             ) ).
  ...
  METHOD icon_tab_bar.
    ...
    result = _generic( name   = `IconTabBar`
                       t_prop = VALUE #( ( n = `class`       v = class )
                                       ( n = `select`      v = select )
                                       ( n = `expand`      v = expand )
                                       ( n = `expandable`  v = z3ui5_cl_util=>boolean_abap_2_json( expandable ) )
                                       ( n = `expanded`    v = z3ui5_cl_util=>boolean_abap_2_json( expanded ) )
                                       ( n = `applyContentPadding`    v = z3ui5_cl_util=>boolean_abap_2_json( applycontentpadding ) )
                                       ( n = `backgroundDesign`    v = backgrounddesign )
                                       ( n = `enableTabReordering`    v = z3ui5_cl_util=>boolean_abap_2_json( enabletabreordering ) )
                                       ( n = `headerBackgroundDesign`    v = headerbackgrounddesign )
                                       ( n = `stretchContentHeight`    v = z3ui5_cl_util=>boolean_abap_2_json( stretchcontentheight ) )
                                       ...
                                       ( n = `id`    v = id )
                                       ( n = `content`    v = content )
                                       ( n = `upperCase`    v = z3ui5_cl_util=>boolean_abap_2_json( uppercase ) )
                                       ( n = `selectedKey` v = selectedkey ) ) ).
  ENDMETHOD.
  ...
  METHOD icon_tab_filter.
    ...
    result = _generic( name   = `IconTabFilter`
                       t_prop = VALUE #( ( n = `icon`        v = icon )
                                       ...
                                       ( n = `showAll`     v = z3ui5_cl_util=>boolean_abap_2_json( showall ) )
                                       ( n = `iconDensityAware`     v = z3ui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                                       ( n = `visible`     v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                       ( n = `count`       v = count )
                                       ( n = `text`        v = text )
  ...
  METHOD illustrated_message.
    ...
    result = _generic( name   = `IllustratedMessage`
                       ...
                       ( n = `enableFormattedText`             v = z3ui5_cl_util=>boolean_abap_2_json( enableformattedtext ) )
  ...
  METHOD image.
    ...
    _generic( name   = `Image`
              t_prop = VALUE #(
                ...
                ( n = `load` v = load )
                ( n = `decorative` v = z3ui5_cl_util=>boolean_abap_2_json( decorative ) )
                ( n = `densityAware` v = z3ui5_cl_util=>boolean_abap_2_json( densityaware ) )
                ( n = `lazyLoading` v = z3ui5_cl_util=>boolean_abap_2_json( lazyloading ) )
                 ) ).
  ENDMETHOD.
  ...
  METHOD input.
    ...
    _generic( name   = `Input`
              t_prop = VALUE #( ( n = `id`               v = id )
                                ...
                                ( n = `type`             v = type )
                                ( n = `maxLength`        v = maxlength )
                                ( n = `showClearIcon`    v = z3ui5_cl_util=>boolean_abap_2_json( showclearicon ) )
                                ( n = `description`      v = description )
                                ( n = `editable`         v = z3ui5_cl_util=>boolean_abap_2_json( editable ) )
                                ( n = `enabled`          v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `visible`          v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `enableTableAutoPopinMode` v = z3ui5_cl_util=>boolean_abap_2_json( enabletableautopopinmode ) )
                                ( n = `enableSuggestionsHighlighting`  v = z3ui5_cl_util=>boolean_abap_2_json( enablesuggestionshighlighting ) )
                                ( n = `showTableSuggestionValueHelp`   v = z3ui5_cl_util=>boolean_abap_2_json( showtablesuggestionvaluehelp ) )
                                ( n = `valueState`       v = valuestate )
                                ( n = `valueStateText`   v = valuestatetext )
                                ( n = `value`            v = value )
                                ( n = `required`          v = z3ui5_cl_util=>boolean_abap_2_json( required ) )
                                ...
                                ( n = `showSuggestion`   v = z3ui5_cl_util=>boolean_abap_2_json( showsuggestion ) )
                                ( n = `valueHelpRequest` v = valuehelprequest )
                                ( n = `autocomplete`     v = z3ui5_cl_util=>boolean_abap_2_json( autocomplete ) )
                                ( n = `valueLiveUpdate`  v = z3ui5_cl_util=>boolean_abap_2_json( valueliveupdate ) )
                                ( n = `submit`           v = z3ui5_cl_util=>boolean_abap_2_json( submit ) )
                                ( n = `showValueHelp`    v = z3ui5_cl_util=>boolean_abap_2_json( showvaluehelp ) )
                                ( n = `valueHelpOnly`    v = z3ui5_cl_util=>boolean_abap_2_json( valuehelponly ) )
                                ( n = `class`            v = class )
                                ( n = `change`            v = change )
  ...
  METHOD interact_donut_chart.
    result = _generic( name   = `InteractiveDonutChart`
                       ns     = `mchart`
                       t_prop = VALUE #( ( n = `selectionChanged`  v = selectionchanged )
                                         ( n = `showError`         v = z3ui5_cl_util=>boolean_abap_2_json( showerror ) )
                                         ( n = `errorMessageTitle` v = errormessagetitle )
                                         ( n = `errorMessage`      v = errormessage )
  ...
  METHOD label.
    ...
    _generic( name   = `Label`
              t_prop = VALUE #( ( n = `text`     v = text )
                                ( n = `displayOnly`   v = z3ui5_cl_util=>boolean_abap_2_json( displayonly ) )
                                ( n = `required`   v = z3ui5_cl_util=>boolean_abap_2_json( required ) )
                                ( n = `showColon`   v = z3ui5_cl_util=>boolean_abap_2_json( showcolon ) )
                                ( n = `textAlign`   v = textalign )
                                ( n = `textDirection`   v = textdirection )
                                ( n = `vAlign`   v = valign )
                                ( n = `width`   v = width )
  ...
  METHOD layered_layout.
    result = _generic( name   = `LayeredLayout`
                       ...
                       t_prop = VALUE #(
                             ...
                             ( n = `mergeEdges`  v = z3ui5_cl_util=>boolean_abap_2_json( mergeEdges ) )
                         ) ).
  ENDMETHOD.
  ...
  METHOD line.
    ...
    result = _generic( name   = `Line`
                       ...
                       t_prop = VALUE #(
                             ...
                             ( n = `hover`        v = hover )
                             ( n = `press`        v = press )
                             ( n = `stretchToCenter`           v = z3ui5_cl_util=>boolean_abap_2_json( stretchToCenter ) )
                             ( n = `selected`           v = z3ui5_cl_util=>boolean_abap_2_json( selected ) )
                             ( n = `visible`           v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                         ) ).
  ...
  METHOD line_micro_chart.
    ...
    _generic( name   = `LineMicroChart`
              ...
              t_prop = VALUE #( ( n = `color`  v = color )
                                ...
                                ( n = `hideOnNoData`    v = z3ui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `showBottomLabels`    v = z3ui5_cl_util=>boolean_abap_2_json( showbottomlabels ) )
                                ( n = `showPoints`    v = z3ui5_cl_util=>boolean_abap_2_json( showpoints ) )
                                ( n = `showThresholdLine`    v = z3ui5_cl_util=>boolean_abap_2_json( showthresholdline ) )
                                ( n = `showThresholdValue`    v = z3ui5_cl_util=>boolean_abap_2_json( showthresholdvalue ) )
                                ( n = `showTopLabels`    v = z3ui5_cl_util=>boolean_abap_2_json( showtoplabels ) )
                                ( n = `maxYValue`  v = maxyvalue ) ) ).
  ENDMETHOD.
  ...
  METHOD link.
    ...
    _generic( name   = `Link`
              ...
              t_prop = VALUE #( ( n = `text`    v = text )
                                ...
                                ( n = `emptyIndicatorMode`      v = emptyindicatormode )
                                ( n = `rel`      v = rel )
                                ( n = `subtle`      v = z3ui5_cl_util=>boolean_abap_2_json( subtle ) )
                                ( n = `textAlign`      v = textalign )
                                ( n = `textDirection`      v = textdirection )
                                ( n = `validateUrl`      v = z3ui5_cl_util=>boolean_abap_2_json( validateurl ) )
                                ( n = `width`      v = width )
                                ( n = `wrapping`      v = z3ui5_cl_util=>boolean_abap_2_json( wrapping ) )
                                ( n = `emphasized`      v = z3ui5_cl_util=>boolean_abap_2_json( emphasized ) )
                                ( n = `enabled` v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) ) ) ).
  ENDMETHOD.
  ...
  METHOD map_container.
    ...
    result = _generic( name  = `MapContainer`
                      ...
                      t_prop = VALUE #(
                            ( n = `id`  v = id )
                            ( n = `autoAdjustHeight`  v = z3ui5_cl_util=>boolean_abap_2_json( autoadjustheight ) )
                        ) ).
  ...
  METHOD message_item.
    result = _generic( name   = `MessageItem`
                       t_prop = VALUE #( ( n = `type`                v = type )
                                         ...
                                         ( n = `textDirection`       v = textdirection )
                                         ( n = `groupName`           v = groupname )
                                         ( n = `activeTitle`         v = z3ui5_cl_util=>boolean_abap_2_json( activetitle ) )
                                         ( n = `counter`             v = counter )
                                         ( n = `markupDescription`   v = z3ui5_cl_util=>boolean_abap_2_json( markupdescription ) ) ) ).
  ENDMETHOD.
  ...
  METHOD message_page.
    result = _generic( name   = `MessagePage`
                       t_prop = VALUE #(
                           ( n = `showHeader`          v = z3ui5_cl_util=>boolean_abap_2_json( show_header ) )
                           ( n = `description`         v = description )
                           ( n = `icon`                v = icon )
                           ( n = `text`                v = text )
                           ( n = `enableFormattedText` v = z3ui5_cl_util=>boolean_abap_2_json( enableformattedtext ) )
  ...
  METHOD message_popover.
    result = _generic( name   = `MessagePopover`
                       t_prop = VALUE #( ( n = `items`             v = items )
                                         ...
                                         ( n = `afterClose`        v = afterclose )
                                         ( n = `beforeClose`       v = beforeclose )
                                         ( n = `initiallyExpanded` v = z3ui5_cl_util=>boolean_abap_2_json( initiallyexpanded ) )
                                         ( n = `groupItems`        v = z3ui5_cl_util=>boolean_abap_2_json( groupitems ) ) ) ).
  ENDMETHOD.
  ...
  METHOD network_graph.
    result = _generic( name   = `Graph`
                       ...
                       t_prop = VALUE #(
                             ...
                             ( n = `enableWheelZoom`           v = z3ui5_cl_util=>boolean_abap_2_json( enableWheelZoom ) )
                             ( n = `enableZoom`           v = z3ui5_cl_util=>boolean_abap_2_json( enableZoom ) )
                             ( n = `noData`           v = z3ui5_cl_util=>boolean_abap_2_json( noData ) )
                             ( n = `visible`           v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                         ) ).
  ...
  METHOD node.
    result = _generic( name   = `Node`
                       ...
                       t_prop = VALUE #(
                             ...
                             ( n = `hover` v = hover )
                             ( n = `press` v = press )
                             ( n = `collapsed`           v = z3ui5_cl_util=>boolean_abap_2_json( collapsed ) )
                             ( n = `selected`           v = z3ui5_cl_util=>boolean_abap_2_json( selected ) )
                             ( n = `showActionLinksButton`           v = z3ui5_cl_util=>boolean_abap_2_json( showActionLinksButton ) )
                             ( n = `showDetailButton`           v = z3ui5_cl_util=>boolean_abap_2_json( showDetailButton ) )
                             ( n = `showExpandButton`           v = z3ui5_cl_util=>boolean_abap_2_json( showExpandButton ) )
                             ( n = `visible`           v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                         ) ).
  ...
  METHOD notification_list_group.
    result = _generic( name   = `NotificationListGroup`
                       t_prop = VALUE #(
                             ...
                             ( n = `visible`           v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                             ( n = `autoPriority`           v = z3ui5_cl_util=>boolean_abap_2_json( autopriority ) )
                             ( n = `collapsed`           v = z3ui5_cl_util=>boolean_abap_2_json( collapsed ) )
                             ( n = `enableCollapseButtonWhenEmpty`           v = z3ui5_cl_util=>boolean_abap_2_json( enablecollapsebuttonwhenempty ) )
                             ( n = `navigated`           v = z3ui5_cl_util=>boolean_abap_2_json( navigated ) )
                             ( n = `selected`           v = z3ui5_cl_util=>boolean_abap_2_json( selected ) )
                             ( n = `showButtons`           v = z3ui5_cl_util=>boolean_abap_2_json( showbuttons ) )
                             ( n = `showCloseButton`           v = z3ui5_cl_util=>boolean_abap_2_json( showclosebutton ) )
                             ( n = `showEmptyGroup`           v = z3ui5_cl_util=>boolean_abap_2_json( showemptygroup ) )
                             ( n = `showItemsCounter`           v = z3ui5_cl_util=>boolean_abap_2_json( showitemscounter ) )
                             ( n = `unread`           v = z3ui5_cl_util=>boolean_abap_2_json( unread ) )
                         ) ).
  ENDMETHOD.
  ...
  METHOD notification_list_item.
    result = _generic( name   = `NotificationListItem`
                       t_prop = VALUE #(
                             ...
                             ( n = `press`  v = press )
                             ( n = `visible`           v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                             ( n = `hideShowMoreButton`           v = z3ui5_cl_util=>boolean_abap_2_json( hideshowmorebutton ) )
                             ( n = `truncate`           v = z3ui5_cl_util=>boolean_abap_2_json( truncate ) )
                             ( n = `highlight`           v = z3ui5_cl_util=>boolean_abap_2_json( highlight ) )
                             ( n = `navigated`           v = z3ui5_cl_util=>boolean_abap_2_json( navigated ) )
                             ( n = `selected`           v = z3ui5_cl_util=>boolean_abap_2_json( selected ) )
                             ( n = `showButtons`           v = z3ui5_cl_util=>boolean_abap_2_json( showbuttons ) )
                             ( n = `showCloseButton`           v = z3ui5_cl_util=>boolean_abap_2_json( showclosebutton ) )
  ...
  METHOD numeric_content.
    ...
    result = _generic( name   = `NumericContent`
                       t_prop = VALUE #( ( n = `value`      v = value )
                                         ...
                                         ( n = `visible` v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `nullifyValue` v = z3ui5_cl_util=>boolean_abap_2_json( nullifyvalue ) )
                                         ( n = `formatterValue` v = z3ui5_cl_util=>boolean_abap_2_json( formattervalue ) )
                                         ( n = `animateTextChange` v = z3ui5_cl_util=>boolean_abap_2_json( animatetextchange ) )
                                         ( n = `adaptiveFontSize` v = z3ui5_cl_util=>boolean_abap_2_json( adaptivefontsize ) )
                                         ( n = `withMargin` v = z3ui5_cl_util=>boolean_abap_2_json( withmargin ) ) ) ).
  ...
  METHOD numeric_header.
    ...
    result = _generic( name = `NumericHeader`
                   ...
                   t_prop   = VALUE #(
                         ...
                         ( n = `statusVisible`           v = z3ui5_cl_util=>boolean_abap_2_json( statusvisible ) )
                         ( n = `numberVisible`           v = z3ui5_cl_util=>boolean_abap_2_json( numbervisible ) )
                         ( n = `iconVisible`           v = z3ui5_cl_util=>boolean_abap_2_json( iconvisible ) )
                         ( n = `visible`           v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                     ) ).
  ENDMETHOD.
  ...
  METHOD object_header.
    ...
    result = _generic( name   = `ObjectHeader`
                       t_prop = VALUE #( ( n = `backgrounddesign`     v = backgrounddesign )
                                         ( n = `condensed`            v = z3ui5_cl_util=>boolean_abap_2_json( condensed ) )
                                         ( n = `fullscreenoptimized`  v = z3ui5_cl_util=>boolean_abap_2_json( fullscreenoptimized ) )
                                         ( n = `icon`                 v = icon )
                                         ( n = `iconactive`           v = z3ui5_cl_util=>boolean_abap_2_json( iconactive ) )
                                         ( n = `iconalt`              v = iconalt )
                                         ( n = `icondensityaware`     v = z3ui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                                         ...
                                         ( n = `intro`                v = intro )
                                         ( n = `introactive`          v = z3ui5_cl_util=>boolean_abap_2_json( introactive ) )
                                         ...
                                         ( n = `responsive`           v = z3ui5_cl_util=>boolean_abap_2_json( responsive ) )
                                         ( n = `showtitleselector`    v = z3ui5_cl_util=>boolean_abap_2_json( showtitleselector ) )
                                         ( n = `title`                v = title )
                                         ( n = `titleactive`          v = z3ui5_cl_util=>boolean_abap_2_json( titleactive ) )
  ...
  METHOD object_number.
    ...
    _generic( name   = `ObjectNumber`
              t_prop = VALUE #( ( n = `emphasized`         v = z3ui5_cl_util=>boolean_abap_2_json( emphasized ) )
                                ( n = `number`             v = number )
                                ( n = `state`              v = state )
                                ( n = `id`          v = id )
                                ( n = `class`          v = class )
                                ...
                                ( n = `numberunit`         v = numberunit )
                                ( n = `active`             v = z3ui5_cl_util=>boolean_abap_2_json( active ) )
                                ( n = `inverted`           v = z3ui5_cl_util=>boolean_abap_2_json( inverted ) )
                                ( n = `visible`            v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `unit`               v = unit ) ) ).
  ENDMETHOD.
  ...
  METHOD object_page_header.
    ...
    _generic( name   = `ObjectPageHeader`
              ns     = `uxap`
              t_prop = VALUE #( ( n = `isActionAreaAlwaysVisible`  v = z3ui5_cl_util=>boolean_abap_2_json( isactionareaalwaysvisible ) )
                                ( n = `isObjectIconAlwaysVisible`       v = z3ui5_cl_util=>boolean_abap_2_json( isobjecticonalwaysvisible ) )
                                ( n = `isObjectSubtitleAlwaysVisible`       v = z3ui5_cl_util=>boolean_abap_2_json( isobjectsubtitlealwaysvisible ) )
                                ( n = `isObjectTitleAlwaysVisible`       v = z3ui5_cl_util=>boolean_abap_2_json( isobjecttitlealwaysvisible ) )
                                ( n = `markChanges`       v = z3ui5_cl_util=>boolean_abap_2_json( markchanges ) )
                                ( n = `markFavorite`       v = z3ui5_cl_util=>boolean_abap_2_json( markfavorite ) )
                                ( n = `markFlagged`       v = z3ui5_cl_util=>boolean_abap_2_json( markflagged ) )
                                ( n = `markLocked`       v = z3ui5_cl_util=>boolean_abap_2_json( marklocked ) )
                                ( n = `objectImageDensityAware`       v = z3ui5_cl_util=>boolean_abap_2_json( objectimagedensityaware ) )
                                ( n = `showMarkers`       v = z3ui5_cl_util=>boolean_abap_2_json( showmarkers ) )
                                ( n = `showPlaceholder`       v = z3ui5_cl_util=>boolean_abap_2_json( showplaceholder ) )
                                ( n = `showTitleSelector`       v = z3ui5_cl_util=>boolean_abap_2_json( showtitleselector ) )
                                ( n = `visible`       v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
  ...
  METHOD object_page_header_action_btn.
    ...
    _generic( name   = `ObjectPageHeaderActionButton`
              ...
              t_prop = VALUE #( ( n = `activeIcon`  v = activeicon )
                                ...
                                ( n = `width`      v = width )
                                ( n = `enabled`    v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `hideIcon`    v = z3ui5_cl_util=>boolean_abap_2_json( hideicon ) )
                                ( n = `hideText`    v = z3ui5_cl_util=>boolean_abap_2_json( hidetext ) )
                                ( n = `iconDensityAware`    v = z3ui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                                ( n = `iconFirst`    v = z3ui5_cl_util=>boolean_abap_2_json( iconfirst ) )
                                ( n = `visible`    v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `press`  v = press ) ) ).
  ...
  METHOD object_page_layout.
    result = _generic(
                 ...
                 ns     = `uxap`
                 t_prop = VALUE #(
                     ( n = `showTitleInHeaderContent` v = z3ui5_cl_util=>boolean_abap_2_json( showtitleinheadercontent ) )
                     ( n = `showEditHeaderButton`     v = z3ui5_cl_util=>boolean_abap_2_json( showeditheaderbutton ) )
                     ( n = `alwaysShowContentHeader`     v = z3ui5_cl_util=>boolean_abap_2_json( alwaysshowcontentheader ) )
                     ( n = `enableLazyLoading`     v = z3ui5_cl_util=>boolean_abap_2_json( enablelazyloading ) )
                     ( n = `flexEnabled`     v = z3ui5_cl_util=>boolean_abap_2_json( flexenabled ) )
                     ( n = `headerContentPinnable`     v = z3ui5_cl_util=>boolean_abap_2_json( headercontentpinnable ) )
                     ( n = `headerContentPinned`     v = z3ui5_cl_util=>boolean_abap_2_json( headercontentpinned ) )
                     ( n = `isChildPage`     v = z3ui5_cl_util=>boolean_abap_2_json( ischildpage ) )
                     ( n = `preserveHeaderStateOnScroll`     v = z3ui5_cl_util=>boolean_abap_2_json( preserveheaderstateonscroll ) )
                     ( n = `showAnchorBar`     v = z3ui5_cl_util=>boolean_abap_2_json( showanchorbar ) )
                     ( n = `showAnchorBarPopover`     v = z3ui5_cl_util=>boolean_abap_2_json( showanchorbarpopover ) )
                     ( n = `showHeaderContent`     v = z3ui5_cl_util=>boolean_abap_2_json( showheadercontent ) )
                     ( n = `showOnlyHighImportance`     v = z3ui5_cl_util=>boolean_abap_2_json( showonlyhighimportance ) )
                     ( n = `subSectionLayout`     v = subsectionlayout )
                     ( n = `toggleHeaderOnTitleClick`     v = z3ui5_cl_util=>boolean_abap_2_json( toggleheaderontitleclick ) )
                     ( n = `useIconTabBar`     v = z3ui5_cl_util=>boolean_abap_2_json( useicontabbar ) )
                     ( n = `useTwoColumnsForLargeScreen`     v = z3ui5_cl_util=>boolean_abap_2_json( usetwocolumnsforlargescreen ) )
                     ( n = `visible`     v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
  ...
  METHOD object_page_section.
    result = _generic( name   = `ObjectPageSection`
                       ns     = `uxap`
                       t_prop = VALUE #( ( n = `titleUppercase`  v = z3ui5_cl_util=>boolean_abap_2_json( titleuppercase ) )
                                         ( n = `title`           v = title )
                                         ( n = `id`              v = id )
                                         ( n = `titleLevel`      v = titlelevel )
                                         ( n = `showTitle`       v = z3ui5_cl_util=>boolean_abap_2_json( showtitle ) )
                                         ( n = `visible`       v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `wrapTitle`       v = z3ui5_cl_util=>boolean_abap_2_json( wraptitle ) )
                                         ( n = `importance`      v = importance ) ) ).
  ENDMETHOD.
  ...
  METHOD object_page_sub_section.
    result = _generic( name   = `ObjectPageSubSection`
                       ...
                       t_prop = VALUE #( ( n = `id`    v = id )
                                         ...
                                         ( n = `titleLevel`    v = titlelevel )
                                         ( n = `showTitle`    v = z3ui5_cl_util=>boolean_abap_2_json( showtitle ) )
                                         ( n = `titleUppercase`    v = z3ui5_cl_util=>boolean_abap_2_json( titleuppercase ) )
                                         ( n = `visible`    v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `title` v = title ) ) ).
  ENDMETHOD.
  ...
  METHOD object_status.
    result = _generic( name   = `ObjectStatus`
                       t_prop = VALUE #( ( n = `active`                v = z3ui5_cl_util=>boolean_abap_2_json( active ) )
                                         ( n = `emptyIndicatorMode`    v = emptyindicatormode )
                                         ( n = `icon`                  v = icon )
                                         ( n = `iconDensityAware`      v = z3ui5_cl_util=>boolean_abap_2_json( icondensityaware ) )
                                         ( n = `inverted`              v = z3ui5_cl_util=>boolean_abap_2_json( inverted ) )
  ...
  METHOD overflow_toolbar.
    result = _generic( name   = `OverflowToolbar`
                       t_prop = VALUE #( ( n = `press`   v = press )
                                         ...
                                         ( n = `active` v = z3ui5_cl_util=>boolean_abap_2_json( active ) )
                                         ( n = `visible` v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `asyncMode` v = z3ui5_cl_util=>boolean_abap_2_json( asyncmode ) )
                                         ( n = `enabled` v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                         ( n = `design`    v = design )
                                         ( n = `type`    v = type )
                                         ( n = `style`    v = style )
  ...
  METHOD page.
    result = _generic( name   = `Page`
                       ns     = ns
                       t_prop = VALUE #( ( n = `title` v = title )
                                         ( n = `showNavButton`  v = z3ui5_cl_util=>boolean_abap_2_json( shownavbutton ) )
                                         ( n = `navButtonPress` v = navbuttonpress )
                                         ( n = `showHeader` v = z3ui5_cl_util=>boolean_abap_2_json( showheader ) )
                                         ( n = `class` v = class )
                                         ( n = `backgroundDesign` v = backgrounddesign )
                                         ( n = `navButtonTooltip` v = navbuttontooltip )
                                         ( n = `titleAlignment` v = titlealignment )
                                         ( n = `titleLevel` v = titlelevel )
                                         ( n = `contentOnlyBusy` v = z3ui5_cl_util=>boolean_abap_2_json( contentonlybusy ) )
                                         ( n = `enableScrolling` v = z3ui5_cl_util=>boolean_abap_2_json( enablescrolling ) )
                                         ( n = `floatingFooter` v = z3ui5_cl_util=>boolean_abap_2_json( floatingfooter ) )
                                         ( n = `showFooter` v = z3ui5_cl_util=>boolean_abap_2_json( showfooter ) )
                                         ( n = `showSubHeader` v = z3ui5_cl_util=>boolean_abap_2_json( showsubheader ) )
                                         ( n = `id` v = id ) ) ).
  ENDMETHOD.
  ...
  METHOD panel.
    ...
    result = _generic( name   = `Panel`
                       t_prop = VALUE #( ( n = `expandable` v = z3ui5_cl_util=>boolean_abap_2_json( expandable ) )
                                         ( n = `expanded`   v = z3ui5_cl_util=>boolean_abap_2_json( expanded ) )
                                         ( n = `stickyHeader`   v = z3ui5_cl_util=>boolean_abap_2_json( stickyheader ) )
                                         ( n = `expandAnimation`   v = z3ui5_cl_util=>boolean_abap_2_json( expandanimation ) )
                                         ( n = `visible`   v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `height`   v = height )
                                         ( n = `backgroundDesign`   v = backgrounddesign )
                                         ( n = `width`   v = width )
  ...
  METHOD process_flow.
    result = _generic( name = `ProcessFlow`
                   ns       = 'commons'
                   t_prop   = VALUE #( ( n = `id`               v = id )
                                     ( n = `foldedCorners`    v = z3ui5_cl_util=>boolean_abap_2_json( foldedcorners ) )
                                     ( n = `scrollable`       v = z3ui5_cl_util=>boolean_abap_2_json( scrollable ) )
                                     ( n = `showLabels`       v = z3ui5_cl_util=>boolean_abap_2_json( showlabels ) )
                                     ( n = `visible`          v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                     ( n = `wheelZoomable`    v = z3ui5_cl_util=>boolean_abap_2_json( wheelzoomable ) )
  ...
  METHOD process_flow_node.
    result = _generic( name = `ProcessFlowNode`
                   ...
                   t_prop   = VALUE #( ( n = `laneId`               v = laneid )
                                     ...
                                     ( n = `texts`                v = texts )
                                     ( n = `highlighted`          v = z3ui5_cl_util=>boolean_abap_2_json( highlighted ) )
                                     ( n = `focused`              v = z3ui5_cl_util=>boolean_abap_2_json( focused ) )
                                     ( n = `selected`             v = z3ui5_cl_util=>boolean_abap_2_json( selected ) )
                                     ( n = `tag`                  v = tag )
                                     ( n = `texts`                v = texts )
                                     ( n = `type`                 v = type ) ) ).
  ...
  METHOD progress_indicator.
    ...
    _generic( name   = `ProgressIndicator`
              t_prop = VALUE #( ( n = `class`        v = class )
                                ...
                                ( n = `showValue`    v = z3ui5_cl_util=>boolean_abap_2_json( showvalue ) )
                                ( n = `state`        v = state ) ) ).
  ENDMETHOD.
  ...
  METHOD radio_button.
    result = _generic( name = `RadioButton`
                   t_prop   = VALUE #( ( n = `activeHandling`  v = z3ui5_cl_util=>boolean_abap_2_json( activehandling ) )
                                     ( n = `editable`        v = z3ui5_cl_util=>boolean_abap_2_json( editable ) )
                                     ( n = `enabled`         v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                     ( n = `selected`        v = z3ui5_cl_util=>boolean_abap_2_json( selected ) )
                                     ( n = `useEntireWidth`  v = z3ui5_cl_util=>boolean_abap_2_json( useentirewidth ) )
...
*              ns     = `webc`
              t_prop = VALUE #( ( n = `class`           v = class )
                                ...
                                ( n = `max`   v = max )
                                ( n = `min`   v = min )
                                ( n = `showTickmarks`   v = z3ui5_cl_util=>boolean_abap_2_json( showtickmarks ) )
  ...
  METHOD rich_text_editor.
    result = _generic( name   = `RichTextEditor`
                       ...
                       t_prop = VALUE #( ( n = `buttonGroups`        v = buttongroups )
                                         ( n = `customToolbar`       v = z3ui5_cl_util=>boolean_abap_2_json( customtoolbar ) )
                                         ( n = `editable`            v = z3ui5_cl_util=>boolean_abap_2_json( editable ) )
                                         ( n = `height`              v = height )
                                         ...
                                         ( n = `required`            v = z3ui5_cl_util=>boolean_abap_2_json( required ) )
                                         ( n = `sanitizeValue`       v = z3ui5_cl_util=>boolean_abap_2_json( sanitizevalue ) )
                                         ( n = `showGroupClipboard`  v = z3ui5_cl_util=>boolean_abap_2_json( showgroupclipboard ) )
                                         ( n = `showGroupFont`       v = z3ui5_cl_util=>boolean_abap_2_json( showgroupfont ) )
                                         ( n = `showGroupFontStyle`  v = z3ui5_cl_util=>boolean_abap_2_json( showgroupfontstyle ) )
                                         ( n = `showGroupInsert`     v = z3ui5_cl_util=>boolean_abap_2_json( showgroupinsert ) )
                                         ( n = `showGroupLink`       v = z3ui5_cl_util=>boolean_abap_2_json( showgrouplink ) )
                                         ( n = `showGroupStructure`  v = z3ui5_cl_util=>boolean_abap_2_json( showgroupstructure ) )
                                         ( n = `showGroupTextAlign`  v = z3ui5_cl_util=>boolean_abap_2_json( showgrouptextalign ) )
                                         ( n = `showGroupUndo`       v = z3ui5_cl_util=>boolean_abap_2_json( showgroupundo ) )
                                         ( n = `useLegacyTheme`      v = z3ui5_cl_util=>boolean_abap_2_json( uselegacytheme ) )
                                         ( n = `wrapping`            v = z3ui5_cl_util=>boolean_abap_2_json( wrapping ) )
                                         ( n = `width`               v = width ) ) ).
  ...
  METHOD scroll_container.
    result = _generic( name   = `ScrollContainer`
                       t_prop = VALUE #( ( n = `height`      v = height )
                                         ...
                                         ( n = `id`          v = id )
                                         ( n = `visible`     v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `vertical`    v = z3ui5_cl_util=>boolean_abap_2_json( vertical ) )
                                         ( n = `horizontal`  v = z3ui5_cl_util=>boolean_abap_2_json( horizontal ) )
                                         ( n = `focusable`   v = z3ui5_cl_util=>boolean_abap_2_json( focusable ) ) ) ).
  ENDMETHOD.
  ...
  METHOD search_field.
    ...
    _generic( name   = `SearchField`
              t_prop = VALUE #( ( n = `width`  v = width )
                                ...
                                ( n = `placeholder` v = placeholder )
                                ( n = `suggest` v = suggest )
                                ( n = `enableSuggestions` v = z3ui5_cl_util=>boolean_abap_2_json( enablesuggestions ) )
                                ( n = `showRefreshButton` v = z3ui5_cl_util=>boolean_abap_2_json( showrefreshbutton ) )
                                ( n = `showSearchButton` v = z3ui5_cl_util=>boolean_abap_2_json( showsearchbutton ) )
                                ( n = `visible` v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `enabled` v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `liveChange` v = livechange ) ) ).
  ENDMETHOD.
  ...
  METHOD select.
    result = _generic( name   = `Select`
                       t_prop = VALUE #(
                             ( n = `id`                  v = id )
                             ( n = `class`                  v = class )
                             ( n = `autoAdjustWidth`     v = z3ui5_cl_util=>boolean_abap_2_json( autoadjustwidth ) )
                             ( n = `columnRatio`         v = columnratio )
                             ( n = `editable`            v = z3ui5_cl_util=>boolean_abap_2_json( editable ) )
                             ( n = `enabled`             v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                             ( n = `forceSelection`      v = z3ui5_cl_util=>boolean_abap_2_json( forceselection ) )
                             ( n = `icon`                v = icon )
                             ( n = `maxWidth`            v = maxwidth )
                             ( n = `name`                v = name )
                             ( n = `required`            v = z3ui5_cl_util=>boolean_abap_2_json( required ) )
                             ( n = `resetOnMissingKey`   v = z3ui5_cl_util=>boolean_abap_2_json( resetonmissingkey ) )
                             ( n = `selectedItemId`      v = selecteditemid )
                             ( n = `selectedKey`         v = selectedkey )
                             ( n = `showSecondaryValues` v = z3ui5_cl_util=>boolean_abap_2_json( showsecondaryvalues ) )
                             ( n = `textAlign`           v = textalign )
                             ...
                             ( n = `valueStateText`      v = valuestatetext )
                             ( n = `width`               v = width )
                             ( n = `wrapItemsText`       v = z3ui5_cl_util=>boolean_abap_2_json( wrapitemstext ) )
                             ( n = `items`               v = items )
                             ( n = `selectedItem`        v = selecteditem )
                             ( n = `change`              v = change )
                             ( n = `liveChange`          v = livechange )
  ...
  METHOD shell.
    result = _generic( name          = `Shell`
                       ns            = ns
                              t_prop = VALUE #( ( n = `appWidthLimited`  v = z3ui5_cl_util=>boolean_abap_2_json( appwidthlimited ) ) ) ).
  ENDMETHOD.
  ...
  METHOD side_panel.
    result = _generic( name   = `SidePanel`
                       ...
                       t_prop = VALUE #( ( n = `sidePanelWidth`  v = sidepanelwidth )
                                         ...
                                         ( n = `sidePanelResizable`    v = z3ui5_cl_util=>boolean_abap_2_json( sidepanelresizable ) )
                                         ( n = `actionBarExpanded`    v = z3ui5_cl_util=>boolean_abap_2_json( actionbarexpanded ) )
                                         ( n = `toggle`    v = toggle )
  ...
  METHOD simple_form.
    result = _generic( name   = `SimpleForm`
                       ...
                       t_prop = VALUE #( ( n = `title`    v = title )
                                         ...
                                         ( n = `minWidth`   v = minwidth )
                                         ( n = `singleContainerFullSize`   v = z3ui5_cl_util=>boolean_abap_2_json( singlecontainerfullsize ) )
                                         ( n = `visible`   v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                         ( n = `width`       v = width )
                                         ( n = `id`       v = id )
...
*              ns     = `webc`
              t_prop = VALUE #( ( n = `class`           v = class )
                                ...
                                ( n = `max`   v = max )
                                ( n = `min`   v = min )
                                ( n = `enableTickmarks`   v = z3ui5_cl_util=>boolean_abap_2_json( enabletickmarks ) )
                                ( n = `enabled`   v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `value`   v = value )
                                ( n = `step`   v = step )
                                ( n = `width`   v = width ) ) ).
  ...
  METHOD smart_variant_management.
    result = _generic( name   = `SmartVariantManagement`
                       ns     = `svm`
                       t_prop = VALUE #( ( n = `id`      v = id )
                                         ( n = `showExecuteOnSelection`  v = z3ui5_cl_util=>boolean_abap_2_json( showexecuteonselection ) ) ) ).
  ENDMETHOD.
  ...
  METHOD stacked_bar_micro_chart.
    ...
    _generic( name   = `StackedBarMicroChart`
              ...
              t_prop = VALUE #( ( n = `height`  v = height )
                                ...
                                ( n = `size`      v = size )
                                ( n = `hideOnNoData`    v = z3ui5_cl_util=>boolean_abap_2_json( hideonnodata ) )
                                ( n = `displayZeroValue`    v = z3ui5_cl_util=>boolean_abap_2_json( displayzerovalue ) )
                                ( n = `showLabels`    v = z3ui5_cl_util=>boolean_abap_2_json( showlabels ) )
                                ( n = `width`  v = width ) ) ).
  ENDMETHOD.
  ...
  METHOD standard_list_item.
    ...
    _generic( name   = `StandardListItem`
              t_prop = VALUE #( ( n = `title`       v = title )
                                ...
                                ( n = `counter`     v = counter )
                                ( n = `activeIcon`     v = activeicon )
                                ( n = `adaptTitleSize`     v = z3ui5_cl_util=>boolean_abap_2_json( adapttitlesize ) )
                                ( n = `unread`     v = z3ui5_cl_util=>boolean_abap_2_json( unread ) )
                                ( n = `iconInset`     v = z3ui5_cl_util=>boolean_abap_2_json( iconinset ) )
                                ( n = `infoStateInverted`     v = z3ui5_cl_util=>boolean_abap_2_json( infostateinverted ) )
                                ( n = `wrapping`     v = z3ui5_cl_util=>boolean_abap_2_json( wrapping ) )
  ...
  METHOD status.
    ...
    result = _generic( name   = `Status`
                       ...
                       t_prop = VALUE #(
                             ...
                             ( n = `title`         v = title )
                             ( n = `useFocusColorAsContentColor`           v = z3ui5_cl_util=>boolean_abap_2_json( useFocusColorAsContentColor ) )
                             ( n = `visible`           v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                         ) ).
  ...
  METHOD table.
    result = _generic( name   = `Table`
                       t_prop = VALUE #(
                           ...
                           ( n = `backgroundDesign`  v = backgrounddesign )
                           ( n = `visible`  v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                           ( n = `alternateRowColors`  v = z3ui5_cl_util=>boolean_abap_2_json( alternaterowcolors ) )
                           ( n = `fixedLayout`  v = z3ui5_cl_util=>boolean_abap_2_json( fixedlayout ) )
                           ( n = `showOverlay`  v = z3ui5_cl_util=>boolean_abap_2_json( showoverlay ) )
                           ( n = `autoPopinMode`  v = z3ui5_cl_util=>boolean_abap_2_json( autopopinmode ) ) ) ).
  ENDMETHOD.
  ...
  METHOD table_select_dialog.
    ...
    result = _generic( name = `TableSelectDialog`
               t_prop       = VALUE #( ( n = `confirmButtonText`    v = confirmbuttontext )
                                 ...
                                 ( n = `growing`              v = z3ui5_cl_util=>boolean_abap_2_json( growing ) )
                                 ( n = `growingThreshold`     v = growingthreshold )
                                 ( n = `multiSelect`          v = z3ui5_cl_util=>boolean_abap_2_json( multiselect ) )
                                 ( n = `noDataText`           v = nodatatext )
                                 ( n = `rememberSelections`   v = z3ui5_cl_util=>boolean_abap_2_json( rememberselections ) )
                                 ( n = `resizable`            v = z3ui5_cl_util=>boolean_abap_2_json( resizable ) )
                                 ( n = `searchPlaceholder`    v = searchplaceholder )
                                 ( n = `showClearButton`      v = z3ui5_cl_util=>boolean_abap_2_json( showclearbutton ) )
                                 ( n = `title`                v = title )
                                 ( n = `titleAlignment`       v = titlealignment )
                                 ( n = `items`                v = items )
                                 ( n = `search`               v = search )
  ...
  METHOD tile_content.
    ...
    result = _generic( name   = `TileContent`
                       ...
                       t_prop = VALUE #(
                                ...
                                ( n = `blocked`   v = z3ui5_cl_util=>boolean_abap_2_json( blocked ) )
                                ( n = `frameType`   v = frametype )
                                ( n = `priority`   v = priority )
                                ( n = `priorityText`   v = prioritytext )
                                ( n = `state`   v = state )
                                ( n = `disabled`   v = z3ui5_cl_util=>boolean_abap_2_json( disabled ) )
                                ( n = `visible`   v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                ( n = `footer` v = footer ) ) ).
  ...
  METHOD timeline.
    ...
    result = _generic( name   = `Timeline`
                       ns     = 'commons'
                       t_prop = VALUE #( ( n = 'id'                 v = id )
                                         ( n = 'enableDoubleSided'  v = z3ui5_cl_util=>boolean_abap_2_json( enabledoublesided ) )
                                         ( n = 'groupBy'            v = groupby )
                                         ( n = 'growingThreshold'   v = growingthreshold )
                                         ( n = 'filterTitle'        v = filtertitle )
                                         ( n = 'sortOldestFirst'    v = z3ui5_cl_util=>boolean_abap_2_json( sortoldestfirst ) )
                                         ( n = 'enableModelFilter'  v = z3ui5_cl_util=>boolean_abap_2_json( enablemodelfilter ) )
                                         ( n = 'enableScroll'       v = z3ui5_cl_util=>boolean_abap_2_json( enablescroll ) )
                                         ( n = 'forceGrowing'       v = z3ui5_cl_util=>boolean_abap_2_json( forcegrowing ) )
                                         ( n = 'group'              v = z3ui5_cl_util=>boolean_abap_2_json( group ) )
                                         ( n = 'lazyLoading'        v = z3ui5_cl_util=>boolean_abap_2_json( lazyloading ) )
                                         ( n = 'showHeaderBar'      v = z3ui5_cl_util=>boolean_abap_2_json( showheaderbar ) )
                                         ( n = 'showIcons'          v = z3ui5_cl_util=>boolean_abap_2_json( showicons ) )
                                         ( n = 'showItemFilter'     v = z3ui5_cl_util=>boolean_abap_2_json( showitemfilter ) )
                                         ( n = 'showSearch'         v = z3ui5_cl_util=>boolean_abap_2_json( showsearch ) )
                                         ( n = 'showSort'           v = z3ui5_cl_util=>boolean_abap_2_json( showsort ) )
                                         ( n = 'showTimeFilter'     v = z3ui5_cl_util=>boolean_abap_2_json( showtimefilter ) )
                                         ( n = 'sort'               v = z3ui5_cl_util=>boolean_abap_2_json( sort ) )
  ...
  METHOD timeline_item.
    ...
    result = _generic( name   = `TimelineItem`
                       ...
                       t_prop = VALUE #( ( n = 'id'                     v = id )
                                         ( n = 'dateTime'               v = datetime )
                                         ( n = 'title'                  v = title )
                                         ( n = 'userNameClickable'      v = z3ui5_cl_util=>boolean_abap_2_json( usernameclickable ) )
                                         ( n = 'useIconTooltip'         v = z3ui5_cl_util=>boolean_abap_2_json( useicontooltip ) )
  ...
  METHOD time_picker.
    ...
    _generic( name   = `TimePicker`
              t_prop = VALUE #( ( n = `value` v = value )
                                ...
                                ( n = `textDirection`  v = textdirection )
                                ( n = `title`  v = title )
                                ( n = `showCurrentTimeButton` v = z3ui5_cl_util=>boolean_abap_2_json( showcurrenttimebutton ) )
                                ( n = `showValueStateMessage` v = z3ui5_cl_util=>boolean_abap_2_json( showvaluestatemessage ) )
                                ( n = `support2400` v = z3ui5_cl_util=>boolean_abap_2_json( support2400 ) )
                                ( n = `initialFocusedDateValue` v = z3ui5_cl_util=>boolean_abap_2_json( initialfocuseddatevalue ) )
                                ( n = `hideInput` v = z3ui5_cl_util=>boolean_abap_2_json( hideinput ) )
                                ( n = `editable` v = z3ui5_cl_util=>boolean_abap_2_json( editable ) )
                                ( n = `enabled` v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                ( n = `required` v = z3ui5_cl_util=>boolean_abap_2_json( required ) )
  ...
  METHOD tree_table.
    ...
    result = _generic( name  = `TreeTable`
                      ...
                      t_prop = VALUE #(
                                        ...
                                        ( n = `enableColumnReordering`  v = z3ui5_cl_util=>boolean_abap_2_json( enableColumnReordering ) )
                                        ( n = `expandFirstLevel`        v = z3ui5_cl_util=>boolean_abap_2_json( expandFirstLevel ) )
                                        ( n = `columnSelect`            v = columnselect )
                                        ( n = `rowSelectionChange`      v = rowselectionchange )
                                        ( n = `selectionBehavior`       v = selectionbehavior )
                                        ( n = `id`                      v = id )
                                        ( n = `alternateRowColors`      v = z3ui5_cl_util=>boolean_abap_2_json( alternaterowcolors ) )
                                        ( n = `columnHeaderVisible`      v = z3ui5_cl_util=>boolean_abap_2_json( columnHeaderVisible ) )
                                        ( n = `enableCellFilter`      v = z3ui5_cl_util=>boolean_abap_2_json( enableCellFilter ) )
                                        ( n = `enableColumnFreeze`      v = z3ui5_cl_util=>boolean_abap_2_json( enableColumnFreeze ) )
                                        ( n = `enableCustomFilter`      v = z3ui5_cl_util=>boolean_abap_2_json( enableCustomFilter ) )
                                        ( n = `enableSelectAll`      v = z3ui5_cl_util=>boolean_abap_2_json( enableSelectAll ) )
                                        ( n = `showNoData`      v = z3ui5_cl_util=>boolean_abap_2_json( showNoData ) )
                                        ( n = `showOverlay`      v = z3ui5_cl_util=>boolean_abap_2_json( showOverlay ) )
                                        ( n = `visible`      v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
                                        ...
                                        ( n = `threshold`           v = threshold )
                                        ( n = `width`           v = width )
                                        ( n = `useGroupMode`           v =  z3ui5_cl_util=>boolean_abap_2_json( useGroupMode ) )
  ...
  METHOD ui_column.
    result = _generic( name   = `Column`
                       ...
                       t_prop = VALUE #(
                          ...
                          ( n = `autoresizable`  v = z3ui5_cl_util=>boolean_abap_2_json( autoresizable ) )
  ...
  METHOD ui_table.
    ...
    result = _generic( name   = `Table`
                       ...
                       t_prop = VALUE #(
                           ...
                           ( n = `editable`                  v = z3ui5_cl_util=>boolean_abap_2_json( editable ) )
                           ( n = `enableCellFilter`          v = z3ui5_cl_util=>boolean_abap_2_json( enablecellfilter ) )
                           ( n = `enableGrouping`            v = z3ui5_cl_util=>boolean_abap_2_json( enablegrouping ) )
                           ( n = `enableSelectAll`           v = z3ui5_cl_util=>boolean_abap_2_json( enableselectall ) )
                           ( n = `firstVisibleRow`           v = firstvisiblerow )
                           ( n = `fixedBottomRowCount`       v = fixedbottomrowcount )
                           ( n = `fixedColumnCount`          v = fixedcolumncount )
                           ...
                           ( n = `selectionMode`             v = selectionmode )
                           ( n = `selectionBehavior`         v = selectionBehavior )
                           ( n = `showColumnVisibilityMenu`  v = z3ui5_cl_util=>boolean_abap_2_json( showcolumnvisibilitymenu ) )
                           ( n = `showNoData`                v = z3ui5_cl_util=>boolean_abap_2_json( shownodata ) )
                           ( n = `threshold`                 v = threshold )
                           ( n = `visibleRowCount`           v = visiblerowcount )
                           ( n = `visibleRowCountMode`       v = visiblerowcountmode )
  ...
  METHOD upload_set.
    result = _generic( name   = `UploadSet`
                       ns     = 'upload'
                       t_prop = VALUE #( ( n = `id`                       v = id )
                                         ( n = `instantUpload`            v = z3ui5_cl_util=>boolean_abap_2_json( instantupload ) )
                                         ( n = `showIcons`                v = z3ui5_cl_util=>boolean_abap_2_json( showicons ) )
                                         ( n = `uploadEnabled`            v = z3ui5_cl_util=>boolean_abap_2_json( uploadenabled ) )
                                         ( n = `terminationEnabled`       v = z3ui5_cl_util=>boolean_abap_2_json( terminationenabled ) )
                                         ( n = `uploadButtonInvisible`    v = z3ui5_cl_util=>boolean_abap_2_json( uploadbuttoninvisible ) )
                                         ...
                                         ( n = `directory`                v = z3ui5_cl_util=>boolean_abap_2_json( directory ) )
                                         ( n = `multiple`                 v = z3ui5_cl_util=>boolean_abap_2_json( multiple ) )
                                         ...
                                         ( n = `sameFilenameAllowed`      v = z3ui5_cl_util=>boolean_abap_2_json( samefilenameallowed ) )
  ...
  METHOD upload_set_item.
    result = _generic( name = `UploadSetItem`
                   ...
                   t_prop   = VALUE #( ( n = `fileName`      v = filename )
                                     ...
                                     ( n = `markers`       v = markers )
                                     ( n = `enabledEdit`   v = z3ui5_cl_util=>boolean_abap_2_json( enablededit ) )
                                     ( n = `enabledRemove` v = z3ui5_cl_util=>boolean_abap_2_json( enabledremove ) )
                                     ( n = `selected`      v = z3ui5_cl_util=>boolean_abap_2_json( selected ) )
                                     ( n = `visibleEdit`   v = z3ui5_cl_util=>boolean_abap_2_json( visibleedit ) )
                                     ( n = `visibleRemove` v = z3ui5_cl_util=>boolean_abap_2_json( visibleremove ) )
  ...
  METHOD variant_item.
    ...
    result = _generic( name     = `VariantItem`
                         ns     = `vm`
                         t_prop = VALUE #( ( n = `executeOnSelection`      v = z3ui5_cl_util=>boolean_abap_2_json( executeonselection ) )
                                           ( n = `global`                  v = z3ui5_cl_util=>boolean_abap_2_json( global ) )
                                           ( n = `labelReadOnly`           v = z3ui5_cl_util=>boolean_abap_2_json( labelreadonly ) )
                                           ...
                                           ( n = `executeOnSelect`         v = z3ui5_cl_util=>boolean_abap_2_json( executeonselect ) )
                                           ( n = `author`                  v = author )
                                           ( n = `changeable`              v = z3ui5_cl_util=>boolean_abap_2_json( changeable ) )
                                           ( n = `enabled`                 v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                           ( n = `favorite`                v = z3ui5_cl_util=>boolean_abap_2_json( favorite ) )
                                           ( n = `key`                     v = key )
                                           ( n = `text`                    v = text )
                                           ( n = `title`                   v = title )
                                           ( n = `textDirection`           v = textdirection )
                                           ( n = `originalTitle`           v = originaltitle )
                                           ( n = `originalExecuteOnSelect` v = z3ui5_cl_util=>boolean_abap_2_json( originalexecuteonselect ) )
                                           ( n = `remove`                  v = z3ui5_cl_util=>boolean_abap_2_json( remove ) )
                                           ( n = `rename`                  v = z3ui5_cl_util=>boolean_abap_2_json( rename ) )
                                           ( n = `originalFavorite`        v = z3ui5_cl_util=>boolean_abap_2_json( originalfavorite ) )
                                           ( n = `sharing`                 v = z3ui5_cl_util=>boolean_abap_2_json( sharing ) )
                                           ( n = `change`                  v = change ) ) ).
  ...
  METHOD variant_management.
    ...
    result = _generic( name   = `VariantManagement`
                       ...
                       t_prop = VALUE #( ( n = `defaultVariantKey`      v = defaultvariantkey )
                                         ( n = `enabled`                v = z3ui5_cl_util=>boolean_abap_2_json( enabled ) )
                                         ( n = `inErrorState`           v = z3ui5_cl_util=>boolean_abap_2_json( inerrorstate ) )
                                         ( n = `initialSelectionKey`    v = initialselectionkey )
                                         ( n = `lifecycleSupport`       v = z3ui5_cl_util=>boolean_abap_2_json( lifecyclesupport ) )
                                         ( n = `selectionKey`           v = selectionkey )
                                         ( n = `showCreateTile`         v = z3ui5_cl_util=>boolean_abap_2_json( showcreatetile ) )
                                         ( n = `showExecuteOnSelection` v = z3ui5_cl_util=>boolean_abap_2_json( showexecuteonselection ) )
                                         ( n = `showSetAsDefault`       v = z3ui5_cl_util=>boolean_abap_2_json( showsetasdefault ) )
                                         ( n = `showShare`              v = z3ui5_cl_util=>boolean_abap_2_json( showshare ) )
                                         ( n = `standardItemAuthor`     v = standarditemauthor )
                                         ( n = `standardItemText`       v = standarditemtext )
                                         ( n = `useFavorites`           v = z3ui5_cl_util=>boolean_abap_2_json( usefavorites ) )
  ...
  METHOD variant_management_fl.
    result = _generic( name   = `VariantManagement`
                       ...
                       t_prop = VALUE #( ( n = `displayTextForExecuteOnSelectionForStandardVariant`  v = displaytextfsv )
                                         ( n = `editable`       v = z3ui5_cl_util=>boolean_abap_2_json( editable ) )
                                         ( n = `executeOnSelectionForStandardDefault`        v = z3ui5_cl_util=>boolean_abap_2_json( executeonselectionforstandflt ) )
                                         ( n = `headerLevel`      v = headerlevel )
                                         ( n = `inErrorState`      v = z3ui5_cl_util=>boolean_abap_2_json( inerrorstate ) )
                                         ( n = `maxWidth`      v = maxwidth )
                                         ( n = `modelName`      v = modelname )
                                         ( n = `resetOnContextChange`      v = z3ui5_cl_util=>boolean_abap_2_json( resetoncontextchange ) )
                                         ( n = `showSetAsDefault`      v = z3ui5_cl_util=>boolean_abap_2_json( showsetasdefault ) )
                                         ( n = `titleStyle`      v = titlestyle )
                                         ( n = `updateVariantInURL`    v = z3ui5_cl_util=>boolean_abap_2_json( updatevariantinurl ) )
                                         ( n = `cancel`    v = cancel )
                                         ( n = `initialized`    v = initialized )
                                         ( n = `manage`    v = manage )
                                         ( n = `save`    v = save )
  ...
  METHOD view_settings_dialog.
    ...
    result = _generic( name = `ViewSettingsDialog`
              t_prop        = VALUE #( ( n = `confirm`                  v = confirm )
                                ...
                                ( n = `groupDescending`          v = z3ui5_cl_util=>boolean_abap_2_json( groupdescending ) )
                                ( n = `sortDescending`           v = z3ui5_cl_util=>boolean_abap_2_json( sortdescending ) )
                                ( n = `title`                    v = title )
  ...
  METHOD wizard.
    result = _generic( name   = `Wizard`
                       t_prop = VALUE #(
                          ...
                          ( n = `class`                v = class )
                          ( n = `backgroundDesign`     v = backgrounddesign )
                          ( n = `busy`                 v = z3ui5_cl_util=>boolean_abap_2_json( busy ) )
                          ( n = `busyIndicatorDelay`   v = busyindicatordelay )
                          ( n = `busyIndicatorSize`    v = busyindicatorsize )
                          ( n = `enableBranching`      v = z3ui5_cl_util=>boolean_abap_2_json( enablebranching ) )
                          ( n = `fieldGroupIds`        v = fieldgroupids )
                          ( n = `finishButtonText`     v = finishbuttontext )
                          ( n = `height`               v = height )
                          ( n = `renderMode`           v = rendermode )
                          ( n = `showNextButton`       v = z3ui5_cl_util=>boolean_abap_2_json( shownextbutton ) )
  ...
  METHOD wizard_step.
    ...
    result = _generic( name   = `WizardStep`
                       t_prop = VALUE #(
                          ...
                          (  n = `fieldGroupIds`        v = fieldgroupids )
                          (  n = `icon`                 v = icon )
                          (  n = `optional`             v = z3ui5_cl_util=>boolean_abap_2_json( optional ) )
                          (  n = `title`                v = title )
                          (  n = `validated`            v = z3ui5_cl_util=>boolean_abap_2_json( validated ) )
                          (  n = `visible`              v = z3ui5_cl_util=>boolean_abap_2_json( visible ) )
  ...
  METHOD xml_get.
    DATA lt_prop TYPE z3ui5_if_types=>ty_t_name_value.
