CLASS z4ui5_cl_xml_view_cc DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS constructor
      IMPORTING
        !view TYPE REF TO z4ui5_cl_xml_view .
  PROTECTED SECTION.
    DATA mo_view TYPE REF TO z4ui5_cl_xml_view.
  PRIVATE SECTION.
ENDCLASS.



CLASS z4ui5_cl_xml_view_cc IMPLEMENTATION.
  ...
  METHOD camera_picture.
    ...
    mo_view->_generic( name = `CameraPicture`
              ...
              t_prop        = VALUE #(
                ...
                ( n = `press`    v = press )
                ( n = `OnPhoto`    v = onphoto )
                ( n = `autoplay` v = z4ui5_cl_util=>boolean_abap_2_json( autoplay ) )
       ) ).
  ...
  METHOD file_uploader.
    ...
    mo_view->_generic( name = `FileUploader`
              ...
              t_prop        = VALUE #( (  n = `placeholder`        v = placeholder )
                                ...
                                (  n = `path`               v = path )
                                (  n = `value`              v = value )
                                (  n = `iconOnly`           v = z4ui5_cl_util=>boolean_abap_2_json( icononly ) )
                                (  n = `buttonOnly`         v = z4ui5_cl_util=>boolean_abap_2_json( buttononly ) )
                                (  n = `buttonText`         v = buttontext )
                                (  n = `uploadButtonText`   v = uploadbuttontext )
                                (  n = `fileType`           v = filetype )
                                (  n = `checkDirectUpload`  v = z4ui5_cl_util=>boolean_abap_2_json( checkdirectupload ) )
                                (  n = `icon`           v = icon )
  ...
  METHOD geolocation.
    ...
    mo_view->_generic( name = `Geolocation`
              ...
              t_prop        = VALUE #(
                    ...
                    ( n = `speed`  v = speed )
                    ( n = `heading`  v = heading )
                    ( n = `enableHighAccuracy`  v = z4ui5_cl_util=>boolean_abap_2_json( enablehighaccuracy ) )
                    ( n = `timeout`  v = timeout )
              ) ).
  ...
  METHOD timer.
    ...
    mo_view->_generic( name = `Timer`
              ...
              t_prop        = VALUE #( ( n = `delayMS`  v = delayms )
                                ( n = `finished`  v = finished )
                                ( n = `checkActive`  v = z4ui5_cl_util=>boolean_abap_2_json( checkactive ) )
                                ( n = `checkRepeat`  v = z4ui5_cl_util=>boolean_abap_2_json( checkrepeat ) )
              ) ).
