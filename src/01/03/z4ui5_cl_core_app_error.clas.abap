CLASS z4ui5_cl_core_app_error DEFINITION
  PUBLIC
  FINAL
  CREATE PROTECTED .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(result) TYPE REF TO z4ui5_cl_core_app_error.
...
CLASS z4ui5_cl_core_app_error IMPLEMENTATION.
...
*    ENDTRY.
    ...
    DATA(view) = z4ui5_cl_xml_view=>factory( ).
