CLASS z4ui5_cl_core_app_search DEFINITION
  PUBLIC
  CREATE PUBLIC .
  ...
  PROTECTED SECTION.
    ...
    METHODS view_display
      IMPORTING
        client TYPE REF TO z4ui5_if_client.
...
CLASS z4ui5_cl_core_app_search IMPLEMENTATION.
  ...
  METHOD view_action_sheet.
    ...
    DATA(action_sheet_view) = z4ui5_cl_xml_view=>factory_popup( ).
  ...
  METHOD view_display.
    ...
    DATA(page) = z4ui5_cl_xml_view=>factory( )->shell( )->page( `abap2UI5 - App Finder`
       )->content( ).
...
*    row->text( ).
  ...
  METHOD view_nest_display.
    ...
    DATA(lo_view_nested) = z4ui5_cl_xml_view=>factory( ).
  ...
  METHOD z4ui5_if_app~main.
    ...
    IF check_initialized = abap_false.
      ...
      TRY.
          z4ui5_cl_util=>db_load_by_handle(
            EXPORTING
              uname  = sy-uname
              handle = z4ui5_cl_util=>rtti_get_classname_by_ref( me )
            IMPORTING
              result = mt_favs ).
      ...
      mt_apps = VALUE #( FOR row IN z4ui5_cl_util=>rtti_get_classes_impl_intf( z4ui5_cl_util=>rtti_get_intfname_by_ref( li_app ) )
        ( name  = row-classname ) ).
      search( ).
      view_display( client ).
      RETURN.
    ...
    CASE client->get( )-event.
      ...
      WHEN `ON_START`.
        ...
        TRY.
          ...
          CATCH cx_root INTO DATA(x).
            client->nav_app_call( z4ui5_cl_popup_to_inform=>factory( x->get_text( ) ) ).
        ENDTRY.
      ...
      WHEN `ON_FAVS_CLEAR`.
        ...
        z4ui5_cl_util=>db_delete_by_handle(
               uname  = sy-uname
              handle = 'z2ui5_cl_app_search_apps'
            ).
        CLEAR mt_favs.
