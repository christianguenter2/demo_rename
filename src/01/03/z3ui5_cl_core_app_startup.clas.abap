CLASS z3ui5_cl_core_app_startup DEFINITION
  PUBLIC
  FINAL
  CREATE PROTECTED .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      RETURNING
        VALUE(result) TYPE REF TO z3ui5_cl_core_app_startup.
  ...
  PROTECTED SECTION.
    DATA mt_classes TYPE z3ui5_cl_stmpncfctn_api=>tt_classes.
...
CLASS z3ui5_cl_core_app_startup IMPLEMENTATION.
  ...
  METHOD on_event_check.
    DATA li_app_test TYPE REF TO z3ui5_if_app.

    TRY.
        ms_home-classname = z3ui5_cl_util=>c_trim_upper( ms_home-classname ).
        ...
        ms_home-url = z3ui5_cl_util=>app_get_url(
                   client    = client
  ...
  METHOD view_display_start.
    ...
    DATA(page2) = z3ui5_cl_xml_view=>factory( )->shell( )->page(
    ...
    DATA(lv_url_samples2) = z3ui5_cl_util=>app_get_url(
                  client    = client
                  classname = 'z2ui5_cl_demo_app_000' ).

    DATA(lv_url_samples3) = z3ui5_cl_util=>app_get_url(
                    client    = client
                    classname = z3ui5_cl_util_api=>rtti_get_classname_by_ref( NEW z3ui5_cl_core_app_search( ) ) ).
    ...
    IF z3ui5_cl_util=>rtti_check_class_exists( `z2ui5_cl_demo_app_000` ).
...
*    simple_form2->label( `Social` ).
  ...
  METHOD z3ui5_if_app~main.
    ...
    IF client->get( )-check_on_navigated = abap_true.
      TRY.
          DATA(lo_f4) = CAST z3ui5_cl_popup_to_select( client->get_app( client->get( )-s_draft-id_prev_app ) ).
  ...
  METHOD z2ui5_on_event.
    ...
    DATA li_app TYPE REF TO z3ui5_if_app.
    ...
    CASE client->get( )-event.
      ...
      WHEN `OPEN_INFO`.
        client->nav_app_call( z3ui5_cl_core_app_info=>factory( ) ).
        RETURN.
      ...
      WHEN 'VALUE_HELP'.
        TRY.
            mt_classes = z3ui5_cl_util=>rtti_get_classes_impl_intf( z3ui5_cl_util=>rtti_get_intfname_by_ref( li_app ) ).
            client->nav_app_call( z3ui5_cl_popup_to_select=>factory( mt_classes ) ).
          CATCH cx_root.
  ...
  METHOD z2ui5_on_init.
    ...
    ms_home-class_editable = abap_true.
    ms_home-btn_icon       = `sap-icon://validate`.
    ms_home-classname      = z3ui5_cl_util_api=>rtti_get_classname_by_ref( NEW z3ui5_cl_app_hello_world( ) ).
