CLASS z5ui5_cl_core_app_error DEFINITION
  PUBLIC
  FINAL
  CREATE PROTECTED .
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS factory
      ...
      RETURNING
        VALUE(result) TYPE REF TO z5ui5_cl_core_app_error.
...
CLASS z5ui5_cl_core_app_error IMPLEMENTATION.
...
*    ENDTRY.
    ...
    DATA(view) = z5ui5_cl_xml_view=>factory( ).
