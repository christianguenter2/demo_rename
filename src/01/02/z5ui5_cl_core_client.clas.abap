CLASS z5ui5_cl_core_client DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    INTERFACES z5ui5_if_client .

    DATA mo_action TYPE REF TO z5ui5_cl_core_action.

    METHODS constructor
      IMPORTING
        !action TYPE REF TO z5ui5_cl_core_action.
...
CLASS z5ui5_cl_core_client IMPLEMENTATION.
  ...
  METHOD z5ui5_if_client~clear.

    IF val = z5ui5_if_client=>cs_clear-view.
  ...
  METHOD z5ui5_if_client~get_app.

    IF id IS NOT INITIAL.
      DATA(lo_app) = z5ui5_cl_core_app=>db_load( id ).
  ...
  METHOD z5ui5_if_client~nav_app_call.
...
*        ELSE app->id_app ).
    ...
    IF app->id_app IS INITIAL.
      app->id_app = z5ui5_cl_util=>uuid_get_c32( ).
    ENDIF.
    result =  app->id_app.
  ENDMETHOD.


  METHOD z5ui5_if_client~nav_app_leave.

    IF app IS NOT BOUND.
      app = z5ui5_if_client~get_app( z5ui5_if_client~get( )-s_draft-id_prev_app_stack ).
    ENDIF.
...
*        ELSE app->id_app ).
  ...
  METHOD z5ui5_if_client~nest2_view_destroy.
  ...
  METHOD z5ui5_if_client~nest2_view_display.
  ...
  METHOD z5ui5_if_client~nest2_view_model_update.
  ...
  METHOD z5ui5_if_client~nest_view_destroy.
  ...
  METHOD z5ui5_if_client~nest_view_display.
  ...
  METHOD z5ui5_if_client~nest_view_model_update.
  ...
  METHOD z5ui5_if_client~popover_destroy.
  ...
  METHOD z5ui5_if_client~popover_display.
  ...
  METHOD z5ui5_if_client~popover_model_update.
  ...
  METHOD z5ui5_if_client~popup_destroy.
  ...
  METHOD z5ui5_if_client~popup_display.
  ...
  METHOD z5ui5_if_client~popup_model_update.
  ...
  METHOD z5ui5_if_client~view_destroy.
  ...
  METHOD z5ui5_if_client~view_display.
  ...
  METHOD z5ui5_if_client~view_model_update.
  ...
  METHOD z5ui5_if_client~_bind.

    DATA(lo_bind) = NEW z5ui5_cl_core_bind_srv( mo_action->mo_app ).
    result = lo_bind->main(
      val    = z5ui5_cl_util=>conv_get_as_data_ref( val )
      type   = z5ui5_if_core_types=>cs_bind_type-one_way
      config = VALUE #(
         path_only     = path
         custom_filter = custom_filter
         custom_mapper = custom_mapper
         tab           = z5ui5_cl_util=>conv_get_as_data_ref( tab )
         tab_index     = tab_index ) ).

  ENDMETHOD.


  METHOD z5ui5_if_client~_bind_clear.
  ...
  METHOD z5ui5_if_client~_bind_edit.

    DATA(lo_bind) = NEW z5ui5_cl_core_bind_srv( mo_action->mo_app ).
    result = lo_bind->main(
      val    = z5ui5_cl_util=>conv_get_as_data_ref( val )
      type   = z5ui5_if_core_types=>cs_bind_type-two_way
      config = VALUE #(
         path_only          = path
         custom_filter      = custom_filter
  ...
  METHOD z5ui5_if_client~_bind_local.
  ...
  METHOD z5ui5_if_client~_event.

    DATA(lo_ui5) = NEW z5ui5_cl_core_event_srv( ).
  ...
  METHOD z5ui5_if_client~_event_client.
