INTERFACE z4ui5_if_core_types
  ...
  TYPES:
    BEGIN OF ty_s_bind_config,
      ...
      view               TYPE string,
      custom_mapper      TYPE REF TO z4ui5_if_ajson_mapping,
      custom_mapper_back TYPE REF TO z4ui5_if_ajson_mapping,
      custom_filter      TYPE REF TO z4ui5_if_ajson_filter,
      custom_filter_back TYPE REF TO z4ui5_if_ajson_filter,
  ...
  TYPES:
    BEGIN OF ty_s_attri,
      ...
      view               TYPE string,
      json_bind_local    TYPE REF TO z4ui5_if_ajson,
      custom_filter      TYPE REF TO z4ui5_if_ajson_filter,
      custom_filter_back TYPE REF TO z4ui5_if_ajson_filter,
      custom_mapper      TYPE REF TO z4ui5_if_ajson_mapping,
      custom_mapper_back TYPE REF TO z4ui5_if_ajson_mapping,
...
*        frontent_event TYPE string,
  ...
  TYPES:
    BEGIN OF ty_s_next,
      o_app_call  TYPE REF TO z4ui5_if_app,
      o_app_leave TYPE REF TO z4ui5_if_app,
  ...
  TYPES:
    BEGIN OF ty_s_http_request_post,
      o_model TYPE REF TO z4ui5_if_ajson,
      BEGIN OF s_front,
        id          TYPE string,
        view        TYPE string,
...
*        app_start        TYPE string,
        ...
        search      TYPE string,
        event       TYPE string,
        o_comp_data TYPE REF TO z4ui5_if_ajson,
      END OF s_front,
      BEGIN OF s_control,
  ...
  TYPES:
    BEGIN OF ty_s_config,
      ...
      pathname         TYPE string,
      search           TYPE string,
      t_startup_params TYPE z4ui5_if_types=>ty_t_name_value,
    END OF ty_s_config.
  ...
  TYPES ty_s_db TYPE z4ui5_t_core_01.
