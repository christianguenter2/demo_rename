CLASS z5ui5_cl_core_http_get DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA ms_request TYPE z5ui5_if_types=>ty_s_http_request_get.
    DATA mv_response TYPE string.

    METHODS constructor
      IMPORTING
        val TYPE z5ui5_if_types=>ty_s_http_request_get OPTIONAL.
  ...
  PROTECTED SECTION.
    ...
    METHODS get_default_config
      RETURNING
        VALUE(result) TYPE z5ui5_if_types=>ty_s_http_request_get-t_config.
...
CLASS z5ui5_cl_core_http_get IMPLEMENTATION.
...
*               `        sap.z2ui5.oDeviceModel.setDefaultBindingMode("OneWay");` && |\n|  &&
  ...
  METHOD get_js_cc_startup.
    ...
    result = ` ` &&
        z5ui5_cl_fw_cc_timer=>get_js( ) &&
        z5ui5_cl_fw_cc_focus=>get_js( ) &&
        z5ui5_cl_fw_cc_title=>get_js( ) &&
        z5ui5_cl_fw_cc_history=>get_js( ) &&
        z5ui5_cl_fw_cc_scrolling=>get_js( ) &&
        z5ui5_cl_fw_cc_info_frontend=>get_js( ) &&
        z5ui5_cl_fw_cc_geolocation=>get_js( ) &&
        z5ui5_cl_fw_cc_file_uploader=>get_js( ) &&
        z5ui5_cl_fw_cc_multiinput_ext=>get_js( ) &&
        z5ui5_cl_fw_cc_uitable_ext=>get_js( ) &&
        z5ui5_cl_fw_cc_util=>get_js( ) &&
        z5ui5_cl_fw_cc_favicon=>get_js( ) &&
       `  `.
  ...
  METHOD main.
    ...
    mv_response = mv_response &&
       z5ui5_cl_fw_cc_debugging_tools=>get_js( ) &&
    ...
    NEW z5ui5_cl_core_draft_srv( )->cleanup( ).
    result = mv_response.
