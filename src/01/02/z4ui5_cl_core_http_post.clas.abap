CLASS z4ui5_cl_core_http_post DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA ms_request      TYPE z4ui5_if_core_types=>ty_s_http_request_post.
    DATA ms_response     TYPE z4ui5_if_core_types=>ty_s_http_response_post.
...
CLASS z4ui5_cl_core_http_post IMPLEMENTATION.


  METHOD constructor.

    mv_request_json = val.
    mo_action = NEW z4ui5_cl_core_action( me ).
  ...
  METHOD main_end.
    ...
    ms_response = VALUE #(
        ...
        s_front-app       = z4ui5_cl_util=>rtti_get_classname_by_ref( mo_action->mo_app->mo_app )
*        s_front-app_start = ms_request-s_front-app_start
  ...
  METHOD main_process.
    TRY.
        ...
        DATA(li_client) = NEW z4ui5_cl_core_client( mo_action ).
        DATA(li_app)    = CAST z4ui5_if_app( mo_action->mo_app->mo_app ).
