CLASS z4ui5_cl_core_app DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA ms_draft   TYPE z4ui5_if_types=>ty_s_get-s_draft.
    ...
    METHODS model_json_parse
      IMPORTING
        !iv_view  TYPE string
        !io_model TYPE REF TO z4ui5_if_ajson.
    ...
    CLASS-METHODS all_xml_parse
      IMPORTING
        !xml          TYPE string
      RETURNING
        VALUE(result) TYPE REF TO z4ui5_cl_core_app.
...
CLASS z4ui5_cl_core_app IMPLEMENTATION.
  ...
  METHOD all_xml_stringify.
    ...
    TRY.
        ...
        result = z4ui5_cl_util=>xml_stringify( me ).
      ...
      CATCH cx_root INTO DATA(x2).
        TRY.
            ...
            DATA(lo_dissolver) = NEW z4ui5_cl_core_dissolve_srv(
              attri = mt_attri
              app   = mo_app ).

            lo_dissolver->main( ).
            lo_dissolver->main( ).
            lo_model = NEW z4ui5_cl_core_attri_srv(
              attri = mt_attri
              app   = mo_app ).
            lo_model->attri_before_save( ).
  ...
  METHOD db_load.
    ...
    DATA(lo_db) = NEW z4ui5_cl_core_draft_srv( ).
  ...
  METHOD db_save.
    ...
    IF mo_app IS BOUND.
      CAST z4ui5_if_app( mo_app )->id_draft = ms_draft-id.
    ENDIF.
  ...
  METHOD model_json_parse.
    ...
    DATA(lo_json_mapper) = NEW z4ui5_cl_core_json_srv( ).
