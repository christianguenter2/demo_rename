CLASS z3ui5_cl_core_http_post DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    DATA ms_request      TYPE z3ui5_if_core_types=>ty_s_http_request_post.
    DATA ms_response     TYPE z3ui5_if_core_types=>ty_s_http_response_post.
...
CLASS z3ui5_cl_core_http_post IMPLEMENTATION.


  METHOD constructor.

    mv_request_json = val.
    mo_action = NEW z3ui5_cl_core_action( me ).
  ...
  METHOD main_end.
    ...
    ms_response = VALUE #(
        ...
        s_front-app       = z3ui5_cl_util=>rtti_get_classname_by_ref( mo_action->mo_app->mo_app )
