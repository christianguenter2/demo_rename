CLASS z3ui5_cl_core_json_srv DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    METHODS request_json_to_abap
      IMPORTING
        !val          TYPE string
      RETURNING
        VALUE(result) TYPE z3ui5_if_core_types=>ty_s_http_request_post.

    METHODS response_abap_to_json
      IMPORTING
        !val          TYPE z3ui5_if_core_types=>ty_s_http_response_post
      RETURNING
    ...
    METHODS model_front_to_back
      IMPORTING
        !view    TYPE string
        !t_attri TYPE REF TO z3ui5_if_core_types=>ty_t_attri
        !model   TYPE REF TO z3ui5_if_ajson.
...
CLASS z3ui5_cl_core_json_srv IMPLEMENTATION.
  ...
  METHOD model_front_to_back.
    ...
    IF line_exists( t_attri->*[ view = view ] ).
      DATA(lv_view) = view.
    ELSE.
      lv_view = z3ui5_if_client=>cs_view-main.
    ENDIF.

    LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri)
      WHERE bind_type = z3ui5_if_core_types=>cs_bind_type-two_way
      AND  view  = lv_view.
      TRY.
    ...
    TRY.
        ...
        LOOP AT t_attri->* REFERENCE INTO DATA(lr_attri) WHERE bind_type <> ``.
          ...
          CASE lr_attri->bind_type.
            WHEN z3ui5_if_core_types=>cs_bind_type-one_way
            OR z3ui5_if_core_types=>cs_bind_type-two_way.

              ASSIGN lr_attri->r_ref->* TO FIELD-SYMBOL(<attribute>).
              ASSERT sy-subrc = 0.
              ajson->set( iv_ignore_empty = abap_false iv_path = `/` iv_val =  <attribute> ).

            WHEN z3ui5_if_core_types=>cs_bind_type-one_time.
  ...
  METHOD request_json_to_abap.
    TRY.
        ...
        result-o_model = z3ui5_cl_ajson=>create_empty( ).
        ...
        TRY.
            ...
            result-s_control-app_start = z3ui5_cl_util=>c_trim_upper( result-s_control-app_start ).
          CATCH cx_root.
        ENDTRY.
        ...
        result-s_control-app_start = z3ui5_cl_util=>c_trim_upper(
        z3ui5_cl_util=>url_param_get( val = `app_start` url = result-s_front-search ) ).
  ...
  METHOD z3ui5_if_ajson_filter~keep_node.
    ...
    CASE iv_visit.
      ...
      WHEN z3ui5_if_ajson_filter=>visit_type-value.
      ...
      WHEN z3ui5_if_ajson_filter=>visit_type-close.
