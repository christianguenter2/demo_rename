...
CLASS z4ui5_cl_core_dissolve_srv DEFINITION LOCAL FRIENDS ltcl_test_dissolve.
...
CLASS ltcl_test_dissolve IMPLEMENTATION.
  ...
  METHOD test_ref.
    ...
    DATA lt_attri TYPE z4ui5_if_core_types=>ty_t_attri.
    DATA(lo_model) = NEW z4ui5_cl_core_dissolve_srv(
      attri = REF #( lt_attri )
      app   = lo_app ).
