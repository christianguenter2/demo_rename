CLASS z5ui5_cl_util_api DEFINITION
  PUBLIC
  CREATE PUBLIC
  INHERITING FROM z5ui5_cl_stmpncfctn_api.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS url_param_create_url
      IMPORTING
        !t_params     TYPE z5ui5_if_types=>ty_t_name_value
      RETURNING
        VALUE(result) TYPE string.
    ...
    CLASS-METHODS url_param_get_tab
      IMPORTING
        !i_val           TYPE clike
      RETURNING
        VALUE(rt_params) TYPE z5ui5_if_types=>ty_t_name_value.
    ...
    CLASS-METHODS filter_get_token_range_mapping
      RETURNING
        VALUE(result) TYPE z5ui5_if_types=>ty_t_name_value.
...
CLASS z5ui5_cl_util_api IMPLEMENTATION.
  ...
  METHOD json_parse.
    TRY.
        ...
        z5ui5_cl_ajson=>parse( val )->to_abap(
          EXPORTING
          iv_corresponding = abap_true
          IMPORTING
            ev_container = data ).

      CATCH z5ui5_cx_ajson_error INTO DATA(x).
