CLASS z3ui5_cl_test_integration_test DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS z3ui5_cl_test_integration_test IMPLEMENTATION.
  ...
  METHOD z3ui5_if_app~main.
    ...
    CASE sv_state.
      ...
      WHEN 'TEST_ONE_WAY'.
        client->view_display( z3ui5_cl_xml_view=>factory( )->shell(
      ...
      WHEN 'TEST_POPUP'.
        ...
        client->popup_display( z3ui5_cl_xml_view=>factory(
    ...
    IF sv_state = 'TEST_NAVIGATE'.
      DATA(lo_app) = NEW z3ui5_cl_test_integration_test( ).
      sv_state = 'LEAVE_APP'.
