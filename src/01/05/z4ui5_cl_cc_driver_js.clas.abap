  CLASS z4ui5_cl_cc_driver_js DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS z4ui5_cl_cc_driver_js IMPLEMENTATION.
...
*                                  pretty_name      = 'X' ).
        TRY.
            DATA(li_ajson) = CAST z4ui5_if_ajson(  z4ui5_cl_ajson=>create_empty( ) ).
            li_ajson->set( iv_path = `/` iv_val = ls_config ).
*            li_ajson = li_ajson->filter( z2ui5_cl_ajson_filter_lib=>create_empty_filter( ) ).
            li_ajson = li_ajson->filter( NEW z4ui5_cl_cc_driver_js( ) ).
            li_ajson = li_ajson->map( z4ui5_cl_ajson_mapping=>create_to_camel_case( ) ).
            li_ajson = li_ajson->map( z4ui5_cl_ajson_mapping=>create_lower_case( ) ).
...
*                                                   pretty_name      = 'X' ).
        TRY.
            li_ajson = CAST z4ui5_if_ajson(  z4ui5_cl_ajson=>create_empty( ) ).
...
`D,Symbol.toStringTag,{value:&quot;Module&quot;}),D}({});`.
    ...
    METHOD z4ui5_if_ajson_filter~keep_node.
      ...
      CASE iv_visit.
        ...
        WHEN  z4ui5_if_ajson_filter=>visit_type-open.
