interface z5ui5_if_ajson
  ...
  data mt_json_tree type z5ui5_if_ajson_types=>ty_nodes_ts read-only.

  " CLONING

  methods clone
    returning
      value(ri_json) type ref to z5ui5_if_ajson
    raising
  ...
  methods get_node_type
    importing
      iv_path type string
    returning
      value(rv_node_type) type z5ui5_if_ajson_types=>ty_node_type.
  ...
  methods set
    importing
      ...
      iv_node_type type z5ui5_if_ajson_types=>ty_node_type optional
    returning
      value(ri_json) type ref to z5ui5_if_ajson
    raising
      z5ui5_cx_ajson_error.
