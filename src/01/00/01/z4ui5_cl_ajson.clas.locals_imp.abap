  ...
  public section.
    ...
    class-methods split_path
      importing
        iv_path type string
      returning
        value(rv_path_name) type z4ui5_if_ajson_types=>ty_path_name.
...
class lcl_utils implementation.
  ...
  method validate_array_index.
    ...
    if not iv_index co '0123456789'.
      z4ui5_cx_ajson_error=>raise( |Cannot add non-numeric key [{ iv_index }] to array [{ iv_path }]| ).
    endif.
    rv_index = iv_index.
    if rv_index = 0.
      z4ui5_cx_ajson_error=>raise( |Cannot add zero key to array [{ iv_path }]| ).
    endif.
...
class lcl_json_parser definition final.
  public section.
    ...
    methods parse
      ...
      returning
        value(rt_json_tree) type z4ui5_if_ajson_types=>ty_nodes_tt
      raising
        z4ui5_cx_ajson_error.
  ...
  private section.
    ...
    types:
      ty_stack_tt TYPE STANDARD TABLE OF ref to z4ui5_if_ajson_types=>ty_node.
    ...
    methods _parse
      ...
      returning
        value(rt_json_tree) type z4ui5_if_ajson_types=>ty_nodes_tt
      raising
        z4ui5_cx_ajson_error cx_dynamic_check. " cx_sxml_error is not released on Steampunk #153
...
class lcl_json_serializer definition final create private.
  public section.
    ...
    class-methods stringify
      importing
        it_json_tree type z4ui5_if_ajson_types=>ty_nodes_ts
  ...
  private section.
    ...
    data mt_json_tree type z4ui5_if_ajson_types=>ty_nodes_ts.
    data mv_keep_item_order type abap_bool.
    ...
    methods stringify_node
      importing
        is_node type z4ui5_if_ajson_types=>ty_node
      raising
        z4ui5_cx_ajson_error.
  ...
  method stringify_node.
    ...
    case is_node-type.
      ...
      when z4ui5_if_ajson_types=>node_type-object.
        lv_item = lv_item && '{'.
      when z4ui5_if_ajson_types=>node_type-string.
        lv_item = lv_item && |"{ escape_string( is_node-value ) }"|.
      when z4ui5_if_ajson_types=>node_type-boolean or z4ui5_if_ajson_types=>node_type-number.
    ...
    if mv_indent_step > 0
      and ( is_node-type = z4ui5_if_ajson_types=>node_type-array or is_node-type = z4ui5_if_ajson_types=>node_type-object )
    ...
    if is_node-type = z4ui5_if_ajson_types=>node_type-array or is_node-type = z4ui5_if_ajson_types=>node_type-object.
...
class lcl_json_to_abap definition final.
  public section.
    ...
    methods to_abap
      importing
        it_nodes     type z4ui5_if_ajson_types=>ty_nodes_ts
      changing
    ...
    methods to_timestamp
      importing
        iv_value         type z4ui5_if_ajson_types=>ty_node-value
      returning
  ...
  private section.
    ...
    data mr_nodes type ref to z4ui5_if_ajson_types=>ty_nodes_ts.
    data mi_custom_mapping type ref to z4ui5_if_ajson_mapping.
    ...
    methods get_node_type
      importing
        is_node            type z4ui5_if_ajson_types=>ty_node optional " Empty for root
        is_parent_type     type ty_type_cache optional
...
class lcl_json_to_abap implementation.
  ...
  method get_node_type.
    ...
    if sy-subrc <> 0.
      ...
      case is_parent_type-type_kind.
        ...
        when lif_kind=>struct_flat or lif_kind=>struct_deep.
          ...
          if sy-subrc <> 0.
            if mv_corresponding = abap_false.
              z4ui5_cx_ajson_error=>raise( |Path not found| ).
            else.
              clear rs_node_type.
              return.
            endif.
        ...
        when others.
          z4ui5_cx_ajson_error=>raise( |Unexpected parent type| ).
      endcase.
  ...
  method any_to_abap.
    ...
    data lx_ajson type ref to z4ui5_cx_ajson_error.
    data lx_root type ref to cx_root.
    data lr_target_field type ref to data.

    field-symbols <n> type z4ui5_if_ajson_types=>ty_node.
    ...
    try.
      ...
      loop at mr_nodes->* assigning <n> using key array_index where path = iv_path.
        ...
        if ls_node_type-type_kind = lif_kind=>data_ref or
          ...
          z4ui5_cx_ajson_error=>raise( 'Cannot assign to ref' ).
        endif.
        ...
        case is_parent_type-type_kind.
          when lif_kind=>table.
            if not ls_node_type-target_field_name co '0123456789'.
              ...
              z4ui5_cx_ajson_error=>raise( 'Need index to access tables' ).
            endif.
        ...
        case <n>-type.
          when z4ui5_if_ajson_types=>node_type-object.
            if ls_node_type-type_kind <> lif_kind=>struct_flat and
              ...
              z4ui5_cx_ajson_error=>raise( 'Expected structure' ).
            endif.
            any_to_abap(
          ...
          when z4ui5_if_ajson_types=>node_type-array.
            if not ls_node_type-type_kind = lif_kind=>table.
              z4ui5_cx_ajson_error=>raise( 'Expected table' ).
            endif.
            any_to_abap(
              iv_path         = <n>-path && <n>-name && '/'
              is_parent_type  = ls_node_type
        ...
        if is_parent_type-tab_item_buf is bound. " Indirect hint that table was sorted/hashed, see get_node_type.
          try.
            ...
            if sy-subrc <> 0.
              z4ui5_cx_ajson_error=>raise( 'Duplicate insertion' ).
            endif.
    ...
    catch z4ui5_cx_ajson_error into lx_ajson.
  ...
  method value_to_abap.
    ...
    if is_node_type-type_kind ca lif_kind=>deep_targets.
      z4ui5_cx_ajson_error=>raise( |Unsupported target for value [{ is_node_type-type_kind }]| ).
    endif.
    ...
    case is_node-type.
      ...
      when z4ui5_if_ajson_types=>node_type-number.
        " TODO: check type ?
      ...
      when others.
        z4ui5_cx_ajson_error=>raise( |Unexpected JSON type [{ is_node-type }]| ).
    endcase.
  ...
  method to_date.
    ...
    if sy-subrc <> 0.
      z4ui5_cx_ajson_error=>raise( 'Unexpected date format' ).
    endif.
  ...
  method to_timestamp.
    ...
    if sy-subrc = 0.
      ...
      if sy-subrc <> 0.
        z4ui5_cx_ajson_error=>raise( 'Unexpected timestamp format' ).
      endif.
    ...
    try.
      ...
      z4ui5_cx_ajson_error=>raise( 'Unexpected error calculating timestamp' ).
    endtry.
  ...
  method to_time.
    ...
    if sy-subrc <> 0.
      z4ui5_cx_ajson_error=>raise( 'Unexpected time format' ).
    endif.
...
class lcl_abap_to_json definition final.
  public section.
    ...
    class-methods convert
      importing
        iv_data            type any
        is_prefix          type z4ui5_if_ajson_types=>ty_path_name optional
        iv_array_index     type i default 0
        ii_custom_mapping  type ref to z4ui5_if_ajson_mapping optional
        is_opts            type z4ui5_if_ajson=>ty_opts optional
        iv_item_order      type i default 0
      returning
        value(rt_nodes)   type z4ui5_if_ajson_types=>ty_nodes_tt
      raising
        z4ui5_cx_ajson_error.
    ...
    class-methods insert_with_type
      importing
        iv_data            type any
        iv_type            type z4ui5_if_ajson_types=>ty_node_type
        is_prefix          type z4ui5_if_ajson_types=>ty_path_name optional
        iv_array_index     type i default 0
        ii_custom_mapping  type ref to z4ui5_if_ajson_mapping optional
        is_opts            type z4ui5_if_ajson=>ty_opts optional
  ...
  private section.
    ...
    methods convert_any
      importing
        ...
        is_prefix type z4ui5_if_ajson_types=>ty_path_name
        iv_index type i default 0
        iv_item_order type i default 0
      changing
        ct_nodes type z4ui5_if_ajson_types=>ty_nodes_tt
      raising
        z4ui5_cx_ajson_error.

    methods convert_ajson
      importing
        io_json type ref to z4ui5_if_ajson
        is_prefix type z4ui5_if_ajson_types=>ty_path_name
        iv_index type i default 0
        iv_item_order type i default 0
      changing
...
class lcl_abap_to_json implementation.
  ...
  method class_constructor.
    ...
    data lo_dummy type ref to z4ui5_cl_ajson.
    ...
    case io_type->kind.
      ...
      when others.
        ...
        elseif io_type->type_kind = lif_kind=>object_ref
          ...
          z4ui5_cx_ajson_error=>raise( |Unsupported type [{ io_type->type_kind
  ...
  method convert_value.
    ...
    if io_type->absolute_name = '\TYPE-POOL=ABAP\TYPE=ABAP_BOOL'
      ...
      ls_node-type = z4ui5_if_ajson_types=>node_type-boolean.
    ...
    elseif io_type->absolute_name = '\TYPE=TIMESTAMP'.
      if mv_format_datetime = abap_true.
        ls_node-type  = z4ui5_if_ajson_types=>node_type-string.
        ls_node-value = format_timestamp( iv_data ).
      else.
        ls_node-type  = z4ui5_if_ajson_types=>node_type-number.
    ...
    elseif io_type->type_kind co lif_kind=>numeric.
      ...
      z4ui5_cx_ajson_error=>raise( |Unexpected elementary type [{
  ...
  method convert_ref.
    ...
    if iv_data is initial.
      ls_node-type  = z4ui5_if_ajson_types=>node_type-null.
      ls_node-value = 'null'.
    else.
      " TODO support data references
      z4ui5_cx_ajson_error=>raise( |Unexpected reference @{ is_prefix-path && is_prefix-name }| ).
    endif.
  ...
  method convert_struc.
    ...
    ls_root-type  = z4ui5_if_ajson_types=>node_type-object.
  ...
  method convert_table.
    ...
    ls_root-path  = is_prefix-path.
    ls_root-name  = is_prefix-name.
    ls_root-type  = z4ui5_if_ajson_types=>node_type-array.
    ls_root-index = iv_index.
    ls_root-order = iv_item_order.
  ...
  method insert_value_with_type.
    ...
    if io_type->type_kind co lif_kind=>texts or
      ...
      if iv_type = z4ui5_if_ajson_types=>node_type-boolean and iv_data <> 'true' and iv_data <> 'false'.
        z4ui5_cx_ajson_error=>raise( |Unexpected boolean value [{ iv_data }] @{ lv_prefix }| ).
      elseif iv_type = z4ui5_if_ajson_types=>node_type-null and iv_data is not initial.
        z4ui5_cx_ajson_error=>raise( |Unexpected null value [{ iv_data }] @{ lv_prefix }| ).
      elseif iv_type = z4ui5_if_ajson_types=>node_type-number and iv_data cn '0123456789. E+-'.
        z4ui5_cx_ajson_error=>raise( |Unexpected numeric value [{ iv_data }] @{ lv_prefix }| ).
      elseif iv_type <> z4ui5_if_ajson_types=>node_type-string and iv_type <> z4ui5_if_ajson_types=>node_type-boolean
        and iv_type <> z4ui5_if_ajson_types=>node_type-null and iv_type <> z4ui5_if_ajson_types=>node_type-number.
        z4ui5_cx_ajson_error=>raise( |Unexpected type for value [{ iv_type },{ iv_data }] @{ lv_prefix }| ).
      endif.
    elseif io_type->type_kind co lif_kind=>numeric.
      if iv_type <> z4ui5_if_ajson_types=>node_type-number.
        z4ui5_cx_ajson_error=>raise( |Unexpected value for numeric [{ iv_data }] @{ lv_prefix }| ).
      endif.
    else.
      z4ui5_cx_ajson_error=>raise( |Unexpected type [{ io_type->type_kind }] @{ lv_prefix }| ).
    endif.
...
interface lif_mutator_runner.
  methods run
    importing
      it_source_tree type z4ui5_if_ajson_types=>ty_nodes_ts
    exporting
      et_dest_tree type z4ui5_if_ajson_types=>ty_nodes_ts
    raising
      z4ui5_cx_ajson_error.
endinterface.
...
class lcl_filter_runner definition final.
  public section.
    ...
    class-methods new
      importing
        ii_filter type ref to z4ui5_if_ajson_filter
      returning
  ...
  private section.
    data mi_filter type ref to z4ui5_if_ajson_filter.
    data mr_source_tree type ref to z4ui5_if_ajson_types=>ty_nodes_ts.
    data mr_dest_tree type ref to z4ui5_if_ajson_types=>ty_nodes_ts.

    methods walk
      importing
        iv_path type string
      changing
        cs_parent type z4ui5_if_ajson_types=>ty_node optional
      raising
        z4ui5_cx_ajson_error.
...
class lcl_filter_runner implementation.
  ...
  method walk.
    ...
    data ls_node type z4ui5_if_ajson_types=>ty_node.

    loop at mr_source_tree->* into ls_node where path = iv_path.
      case ls_node-type.
        when z4ui5_if_ajson_types=>node_type-boolean or z4ui5_if_ajson_types=>node_type-null
          or z4ui5_if_ajson_types=>node_type-number or z4ui5_if_ajson_types=>node_type-string.

          if mi_filter->keep_node( ls_node ) = abap_false.
            continue.
          endif.

        when z4ui5_if_ajson_types=>node_type-array or z4ui5_if_ajson_types=>node_type-object.

          if mi_filter->keep_node(
              is_node  = ls_node
              iv_visit = z4ui5_if_ajson_filter=>visit_type-open ) = abap_false.
            continue.
          endif.
          ...
          if mi_filter->keep_node(
              is_node  = ls_node
              iv_visit = z4ui5_if_ajson_filter=>visit_type-close ) = abap_false.
            continue.
          endif.

        when others.
          z4ui5_cx_ajson_error=>raise( |Unexpected node type { ls_node-type }| ).
      endcase.

      if cs_parent is supplied.
        cs_parent-children = cs_parent-children + 1.
        if cs_parent-type = z4ui5_if_ajson_types=>node_type-array.
...
class lcl_mapper_runner definition final.
  public section.
    ...
    class-methods new
      importing
        ii_mapper type ref to z4ui5_if_ajson_mapping
      returning
  ...
  private section.
    data mi_mapper type ref to z4ui5_if_ajson_mapping.
    data mr_source_tree type ref to z4ui5_if_ajson_types=>ty_nodes_ts.
    data mr_dest_tree type ref to z4ui5_if_ajson_types=>ty_nodes_ts.
    ...
    methods process_deep_node
      importing
        ...
        iv_node_type    type z4ui5_if_ajson_types=>ty_node-type
      raising
        z4ui5_cx_ajson_error.
...
class lcl_mapper_runner implementation.
  ...
  method lif_mutator_runner~run.
    ...
    if sy-subrc <> 0
      or not ( <root>-type = z4ui5_if_ajson_types=>node_type-array or <root>-type = z4ui5_if_ajson_types=>node_type-object ).
  ...
  method process_deep_node.
    ...
    loop at mr_source_tree->* assigning <item> where path = iv_path.
      ...
      if iv_node_type <> z4ui5_if_ajson_types=>node_type-array.
      ...
      if <item>-type = z4ui5_if_ajson_types=>node_type-array or <item>-type = z4ui5_if_ajson_types=>node_type-object.
        process_deep_node(
...
class lcl_mutator_queue implementation.
  ...
  method lif_mutator_runner~run.
    ...
    data lr_buf type ref to z4ui5_if_ajson_types=>ty_nodes_ts.
