class z4ui5_cl_ajson definition
  public
  create public .

  public section.

    interfaces z4ui5_if_ajson .

    aliases:
      is_empty for z4ui5_if_ajson~is_empty,
      exists for z4ui5_if_ajson~exists,
      members for z4ui5_if_ajson~members,
      get for z4ui5_if_ajson~get,
      get_boolean for z4ui5_if_ajson~get_boolean,
      get_integer for z4ui5_if_ajson~get_integer,
      get_number for z4ui5_if_ajson~get_number,
      get_date for z4ui5_if_ajson~get_date,
      get_timestamp for z4ui5_if_ajson~get_timestamp,
      get_string for z4ui5_if_ajson~get_string,
      slice for z4ui5_if_ajson~slice,
      to_abap for z4ui5_if_ajson~to_abap,
      array_to_string_table for z4ui5_if_ajson~array_to_string_table.

    aliases:
      clear for z4ui5_if_ajson~clear,
      set for z4ui5_if_ajson~set,
      setx for z4ui5_if_ajson~setx,
      set_boolean for z4ui5_if_ajson~set_boolean,
      set_string for z4ui5_if_ajson~set_string,
      set_integer for z4ui5_if_ajson~set_integer,
      set_date for z4ui5_if_ajson~set_date,
      set_timestamp for z4ui5_if_ajson~set_timestamp,
      set_null for z4ui5_if_ajson~set_null,
      delete for z4ui5_if_ajson~delete,
      touch_array for z4ui5_if_ajson~touch_array,
      push for z4ui5_if_ajson~push,
      stringify for z4ui5_if_ajson~stringify.

    aliases:
      clone for z4ui5_if_ajson~clone,
      filter for z4ui5_if_ajson~filter,
      map for z4ui5_if_ajson~map.

    aliases:
      mt_json_tree for z4ui5_if_ajson~mt_json_tree,
      keep_item_order for z4ui5_if_ajson~keep_item_order,
      format_datetime for z4ui5_if_ajson~format_datetime,
      to_abap_corresponding_only for z4ui5_if_ajson~to_abap_corresponding_only,
      freeze for z4ui5_if_ajson~freeze.

    class-methods parse
      importing
        !iv_json            type string
        !iv_freeze          type abap_bool default abap_false
        !ii_custom_mapping  type ref to z4ui5_if_ajson_mapping optional
        !iv_keep_item_order type abap_bool default abap_false
      returning
        value(ro_instance) type ref to z4ui5_cl_ajson
      raising
    ...
    class-methods create_from " TODO, rename to 'from' ?
      importing
        !ii_source_json type ref to z4ui5_if_ajson
        !ii_filter type ref to z4ui5_if_ajson_filter optional " Might be deprecated, use filter() instead
        !ii_mapper type ref to z4ui5_if_ajson_mapping optional " Might be deprecated, use map() instead
      returning
        value(ro_instance) type ref to z4ui5_cl_ajson
      raising
        z4ui5_cx_ajson_error .
  ...
  private section.
    ...
    data ms_opts type z4ui5_if_ajson=>ty_opts.
    data mi_custom_mapping type ref to z4ui5_if_ajson_mapping. " DEPRECATED, will be removed

    methods get_item
      importing
        iv_path        type string
      returning
        value(rv_item) type ref to z4ui5_if_ajson_types=>ty_node.
    methods prove_path_exists
      importing
        iv_path              type string
      returning
        value(rr_end_node) type ref to z4ui5_if_ajson_types=>ty_node
      raising
        z4ui5_cx_ajson_error.
    methods delete_subtree
      importing
        iv_path           type string
        iv_name           type string
        ir_parent         type ref to z4ui5_if_ajson_types=>ty_node optional
      returning
        value(rs_top_node) type z4ui5_if_ajson_types=>ty_node.
...
CLASS z4ui5_cl_ajson IMPLEMENTATION.
  ...
  method create_from.
    ...
    if ii_source_json is not bound.
      z4ui5_cx_ajson_error=>raise( 'Source not bound' ).
    endif.
  ...
  method get_item.
    ...
    data ls_path_name type z4ui5_if_ajson_types=>ty_path_name.
    ...
    do.
      ...
      if sy-subrc <> 0. " New node, assume it is always object as it has a named child, use touch_array to init array
        ...
        if lr_node_parent is not initial. " if has parent
          ...
          if lr_node_parent->type = z4ui5_if_ajson_types=>node_type-array.
        ...
        ls_new_node-type = z4ui5_if_ajson_types=>node_type-object.
  ...
  method read_only_watchdog.
    if ms_opts-read_only = abap_true.
      z4ui5_cx_ajson_error=>raise( 'This json instance is read only' ).
    endif.
  endmethod.


  method z4ui5_if_ajson~array_to_string_table.

    data lv_normalized_path type string.
    data lr_node type ref to z4ui5_if_ajson_types=>ty_node.
    field-symbols <item> like line of mt_json_tree.
    ...
    if lr_node is initial.
      z4ui5_cx_ajson_error=>raise( |Path not found: { iv_path }| ).
    endif.
    if lr_node->type <> z4ui5_if_ajson_types=>node_type-array.
      z4ui5_cx_ajson_error=>raise( |Array expected at: { iv_path }| ).
    endif.

    loop at mt_json_tree assigning <item> where path = lv_normalized_path.
      case <item>-type.
        when z4ui5_if_ajson_types=>node_type-number or z4ui5_if_ajson_types=>node_type-string.
          append <item>-value to rt_string_table.
        when z4ui5_if_ajson_types=>node_type-null.
          append '' to rt_string_table.
        when z4ui5_if_ajson_types=>node_type-boolean.
        ...
        when others.
          z4ui5_cx_ajson_error=>raise( |Cannot convert [{ <item>-type
  ...
  method z4ui5_if_ajson~clone.
    ri_json = create_from( me ).
  endmethod.


  method z4ui5_if_ajson~delete.

    read_only_watchdog( ).

    data ls_split_path type z4ui5_if_ajson_types=>ty_path_name.
  ...
  method z4ui5_if_ajson~exists.
    rv_exists = boolc( get_item( iv_path ) is not initial ).
  endmethod.


  method z4ui5_if_ajson~filter.
    ri_json = create_from(
      ii_source_json = me
      ii_filter      = ii_filter ).
  endmethod.
  ...
  method z4ui5_if_ajson~format_datetime.
    ms_opts-format_datetime = iv_use_iso.
    ri_json = me.
  endmethod.


  method z4ui5_if_ajson~freeze.
    ms_opts-read_only = abap_true.
  endmethod.


  method z4ui5_if_ajson~get.

    data lr_item type ref to z4ui5_if_ajson_types=>ty_node.
  ...
  method z4ui5_if_ajson~get_boolean.

    data lr_item type ref to z4ui5_if_ajson_types=>ty_node.
    lr_item = get_item( iv_path ).
    if lr_item is initial or lr_item->type = z4ui5_if_ajson_types=>node_type-null.
      return.
    elseif lr_item->type = z4ui5_if_ajson_types=>node_type-boolean.
  ...
  method z4ui5_if_ajson~get_date.
    ...
    if lr_item is not initial and lr_item->type = z4ui5_if_ajson_types=>node_type-string.
  ...
  method z4ui5_if_ajson~get_integer.

    data lr_item type ref to z4ui5_if_ajson_types=>ty_node.
    lr_item = get_item( iv_path ).
    if lr_item is not initial and lr_item->type = z4ui5_if_ajson_types=>node_type-number.
      rv_value = lr_item->value.
    endif.
  ...
  method z4ui5_if_ajson~get_node_type.
  ...
  method z4ui5_if_ajson~get_number.
  ...
  method z4ui5_if_ajson~get_string.

    data lr_item type ref to z4ui5_if_ajson_types=>ty_node.
    lr_item = get_item( iv_path ).
    if lr_item is not initial and lr_item->type <> z4ui5_if_ajson_types=>node_type-null.
      rv_value = lr_item->value.
    endif.
  ...
  method z4ui5_if_ajson~get_timestamp.
  ...
  method z4ui5_if_ajson~is_empty.
    rv_yes = boolc( lines( mt_json_tree ) = 0 ).
  endmethod.


  method z4ui5_if_ajson~keep_item_order.
    ms_opts-keep_item_order = abap_true.
    ri_json = me.
  endmethod.


  method z4ui5_if_ajson~map.
    ri_json = create_from(
      ii_source_json = me
      ii_mapper      = ii_mapper ).
  endmethod.
  ...
  method z4ui5_if_ajson~opts.
    rs_opts = ms_opts.
  endmethod.


  method z4ui5_if_ajson~push.

    data lr_parent type ref to z4ui5_if_ajson_types=>ty_node.
    data lr_new_node type ref to z4ui5_if_ajson_types=>ty_node.
    ...
    if lr_parent is initial.
      z4ui5_cx_ajson_error=>raise( |Path [{ iv_path }] does not exist| ).
    endif.

    if lr_parent->type <> z4ui5_if_ajson_types=>node_type-array.
      z4ui5_cx_ajson_error=>raise( |Path [{ iv_path }] is not array| ).
    endif.

    data lt_new_nodes type z4ui5_if_ajson_types=>ty_nodes_tt.
    data ls_new_path type z4ui5_if_ajson_types=>ty_path_name.
  ...
  method z4ui5_if_ajson~set.

    data ls_split_path type z4ui5_if_ajson_types=>ty_path_name.
    data lr_parent type ref to z4ui5_if_ajson_types=>ty_node.
    data ls_deleted_node type z4ui5_if_ajson_types=>ty_node.
    data lv_item_order type z4ui5_if_ajson_types=>ty_node-order.
    ...
    if iv_node_type is not initial
      and iv_node_type <> z4ui5_if_ajson_types=>node_type-boolean and iv_node_type <> z4ui5_if_ajson_types=>node_type-null
      and iv_node_type <> z4ui5_if_ajson_types=>node_type-number and iv_node_type <> z4ui5_if_ajson_types=>node_type-string.
      z4ui5_cx_ajson_error=>raise( |Unexpected type { iv_node_type }| ).
    endif.
    ...
    elseif lr_parent->type = z4ui5_if_ajson_types=>node_type-object
  ...
  method z4ui5_if_ajson~setx.
    ...
    if lv_val = 'null'.
      z4ui5_if_ajson~set_null( lv_path ).
    elseif lv_val = 'true'.
      z4ui5_if_ajson~set_boolean(
        iv_path = lv_path
        iv_val  = abap_true ).
    elseif lv_val = 'false'.
      z4ui5_if_ajson~set_boolean(
  ...
  method z4ui5_if_ajson~set_boolean.
  ...
  method z4ui5_if_ajson~set_date.
  ...
  method z4ui5_if_ajson~set_integer.
  ...
  method z4ui5_if_ajson~set_null.
  ...
  method z4ui5_if_ajson~set_string.
  ...
  method z4ui5_if_ajson~set_timestamp.
  ...
  method z4ui5_if_ajson~slice.

    data lo_section         type ref to z4ui5_cl_ajson.
    data ls_item            like line of mt_json_tree.
    data lv_normalized_path type string.
    data ls_path_parts      type z4ui5_if_ajson_types=>ty_path_name.
  ...
  method z4ui5_if_ajson~stringify.
  ...
  method z4ui5_if_ajson~touch_array.
    ...
    if ls_split_path is initial. " Assign root, exceptional processing
      ...
      ls_new_node-type = z4ui5_if_ajson_types=>node_type-array.
    ...
    elseif lr_node->type <> z4ui5_if_ajson_types=>node_type-array.
      z4ui5_cx_ajson_error=>raise( |Path [{ iv_path }] already used and is not array| ).
    endif.
  ...
  method z4ui5_if_ajson~to_abap.
    ...
    lo_to_abap->to_abap(
      exporting
        it_nodes    = z4ui5_if_ajson~mt_json_tree
      changing
  ...
  method z4ui5_if_ajson~to_abap_corresponding_only.
