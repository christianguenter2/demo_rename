class ltcl_test_mappers definition final for testing
  ...
  private section.
    methods:
      from_json_to_json for testing raising z3ui5_cx_ajson_error,
      to_abap for testing raising z3ui5_cx_ajson_error,
      to_json for testing raising z3ui5_cx_ajson_error,
      to_json_nested_struc for testing raising z3ui5_cx_ajson_error,
      to_json_nested_table for testing raising z3ui5_cx_ajson_error,
      to_json_first_lower for testing raising z3ui5_cx_ajson_error.

    methods:
      to_snake for testing raising z3ui5_cx_ajson_error,
      to_camel for testing raising z3ui5_cx_ajson_error,
      to_camel_1st_upper for testing raising z3ui5_cx_ajson_error,
      rename_by_attr for testing raising z3ui5_cx_ajson_error,
      rename_by_path for testing raising z3ui5_cx_ajson_error,
      rename_by_pattern for testing raising z3ui5_cx_ajson_error,
      compound_mapper for testing raising z3ui5_cx_ajson_error,
      test_to_upper for testing raising z3ui5_cx_ajson_error,
      test_to_lower for testing raising z3ui5_cx_ajson_error.
...
class ltcl_test_mappers implementation.
  ...
  method from_json_to_json.
    ...
    data:
      lo_ajson type ref to z3ui5_cl_ajson.

    lo_ajson =
        z3ui5_cl_ajson=>parse(
            iv_json           = `{"fieldData":"field_value"}`
            ii_custom_mapping = z3ui5_cl_ajson_mapping=>create_camel_case( iv_first_json_upper = abap_false ) ).
  ...
  method to_abap.
    ...
    data:
      lo_ajson   type ref to z3ui5_cl_ajson,
      li_mapping type ref to z3ui5_if_ajson_mapping.
    data:
      begin of ls_result,
        field_data type string,
      end of ls_result.

    li_mapping = z3ui5_cl_ajson_mapping=>create_camel_case( ).

    lo_ajson = z3ui5_cl_ajson=>parse( iv_json = '{"FieldData":"field_value"}' ii_custom_mapping = li_mapping ).
  ...
  method to_json.
    ...
    li_mapping = z3ui5_cl_ajson_mapping=>create_camel_case( iv_first_json_upper = abap_false ).

    ls_result-field_data = 'field_value'.

    lo_ajson = z3ui5_cl_ajson=>create_empty( ii_custom_mapping = li_mapping ).
  ...
  method rename_by_attr.
    ...
    data lt_map type z3ui5_if_ajson_mapping=>tty_rename_map.
...
class ltcl_fields definition final for testing
  ...
  private section.
    methods:
      to_json_without_path for testing raising z3ui5_cx_ajson_error,
      to_json_with_path for testing raising z3ui5_cx_ajson_error,
      to_abap for testing raising z3ui5_cx_ajson_error,
      to_json importing iv_path type string returning value(rv_result) type string raising z3ui5_cx_ajson_error.
...
class ltcl_fields implementation.
  ...
  method to_abap.
    ...
    data:
      lo_ajson          type ref to z3ui5_cl_ajson,
      li_mapping        type ref to z3ui5_if_ajson_mapping,
      lt_mapping_fields type z3ui5_if_ajson_mapping=>ty_mapping_fields,
    ...
    li_mapping = z3ui5_cl_ajson_mapping=>create_field_mapping( lt_mapping_fields ).

    lo_ajson =
        z3ui5_cl_ajson=>parse( iv_json = '{"field":"value","json.field":"field_value"}' ii_custom_mapping = li_mapping ).
...
class ltcl_to_lower implementation.
  ...
  method to_json.
    ...
    li_mapping = z3ui5_cl_ajson_mapping=>create_lower_case( ).
...
class ltcl_to_upper implementation.
  ...
  method to_json.
    ...
    li_mapping = z3ui5_cl_ajson_mapping=>create_upper_case( ).
