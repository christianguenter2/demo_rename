...
class lcl_nodes_helper definition final.
  public section.
    ...
    data mt_nodes type z4ui5_if_ajson_types=>ty_nodes_tt read-only.
...
class ltcl_json_utils definition
  ...
  private section.
    ...
    methods json_diff for testing raising z4ui5_cx_ajson_error.
    methods json_diff_types for testing raising z4ui5_cx_ajson_error.
    methods json_diff_arrays for testing raising z4ui5_cx_ajson_error.
    methods json_merge for testing raising z4ui5_cx_ajson_error.
    methods json_sort for testing raising z4ui5_cx_ajson_error.
    methods is_equal for testing raising z4ui5_cx_ajson_error.
...
class ltcl_json_utils implementation.
  ...
  method json_diff.
    ...
    data:
      lv_json       type string,
      lo_util       type ref to z4ui5_cl_ajson_utilities,
      lo_insert     type ref to z4ui5_if_ajson,
      lo_delete     type ref to z4ui5_if_ajson,
      lo_change     type ref to z4ui5_if_ajson,
...
*      '        "row": 4,\n' && " array delete
  ...
  method json_merge.
    ...
    data:
      ...
      lv_json_b    type string,
      lo_util      type ref to z4ui5_cl_ajson_utilities,
      lo_merge     type ref to z4ui5_if_ajson,
  ...
  method is_equal.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = z4ui5_cl_ajson_utilities=>new( )->is_equal(
        ii_json_a = z4ui5_cl_ajson=>parse( '{"a":1,"b":2}' )
        ii_json_b = z4ui5_cl_ajson=>parse( '{"a":1,"b":2}' ) )
      exp = abap_true ).
