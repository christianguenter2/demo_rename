class z5ui5_cl_ajson_mapping definition
  public
  final
  create public.
  ...
  public section.
    ...
    class-methods create_camel_case " DEPRECATED
      importing
        it_mapping_fields   type z5ui5_if_ajson_mapping=>ty_mapping_fields optional
        iv_first_json_upper type abap_bool default abap_true
      returning
        value(ri_mapping)   type ref to z5ui5_if_ajson_mapping.
    ...
    class-methods create_field_mapping " DEPRECATED
      importing
        it_mapping_fields type z5ui5_if_ajson_mapping=>ty_mapping_fields
      returning
        value(ri_mapping) type ref to z5ui5_if_ajson_mapping.

    class-methods create_rename
      importing
        it_rename_map type z5ui5_if_ajson_mapping=>tty_rename_map
    ...
    class-methods create_compound_mapper
      importing
        ii_mapper1 type ref to z5ui5_if_ajson_mapping optional
        ii_mapper2 type ref to z5ui5_if_ajson_mapping optional
        ii_mapper3 type ref to z5ui5_if_ajson_mapping optional
        it_more type z5ui5_if_ajson_mapping=>ty_table_of optional
      returning
        value(ri_mapping) type ref to z5ui5_if_ajson_mapping.
...
CLASS z5ui5_cl_ajson_mapping IMPLEMENTATION.
  ...
  method create_compound_mapper.
    ...
    data lt_queue type z5ui5_if_ajson_mapping=>ty_table_of.
