class z5ui5_cl_ajson_utilities definition
  public
  create public .
  ...
  public section.
    ...
    class-methods new
      returning
        value(ro_instance) type ref to z5ui5_cl_ajson_utilities.
    methods diff
      importing
        !iv_json_a            type string optional
        !iv_json_b            type string optional
        !io_json_a            type ref to z5ui5_if_ajson optional
        !io_json_b            type ref to z5ui5_if_ajson optional
        !iv_keep_empty_arrays type abap_bool default abap_false
      exporting
        !eo_insert            type ref to z5ui5_if_ajson
        !eo_delete            type ref to z5ui5_if_ajson
        !eo_change            type ref to z5ui5_if_ajson
      raising
    ...
    methods merge
      importing
        ...
        !iv_keep_empty_arrays type abap_bool default abap_false
      returning
        value(ro_json)        type ref to z5ui5_if_ajson
      raising
        z5ui5_cx_ajson_error .
    methods sort
      importing
        !iv_json         type string optional
        !io_json         type ref to z5ui5_if_ajson optional
      returning
    ...
    methods is_equal
      importing
        !iv_json_a            type string optional
        !iv_json_b            type string optional
        !ii_json_a            type ref to z5ui5_if_ajson optional
        !ii_json_b            type ref to z5ui5_if_ajson optional
      returning
  ...
  private section.
    ...
    data mo_json_a type ref to z5ui5_if_ajson .
    data mo_json_b type ref to z5ui5_if_ajson .
    data mo_insert type ref to z5ui5_if_ajson .
    data mo_delete type ref to z5ui5_if_ajson .
    data mo_change type ref to z5ui5_if_ajson .
...
CLASS z5ui5_cl_ajson_utilities IMPLEMENTATION.
    ...
    do.
      ...
      if iv_keep_empty_arrays = abap_false.
        loop at io_json->mt_json_tree into ls_json_tree
          where type = z5ui5_if_ajson_types=>node_type-array and children = 0.
      ...
      loop at io_json->mt_json_tree into ls_json_tree
        where type = z5ui5_if_ajson_types=>node_type-object and children = 0.
  ...
  method diff.
    ...
    mo_insert = z5ui5_cl_ajson=>create_empty( ).
    mo_delete = z5ui5_cl_ajson=>create_empty( ).
    mo_change = z5ui5_cl_ajson=>create_empty( ).
  ...
  method is_equal.
    ...
    data li_ins type ref to z5ui5_if_ajson.
    data li_del type ref to z5ui5_if_ajson.
    data li_mod type ref to z5ui5_if_ajson.
  ...
  method normalize_input.
    ...
    if boolc( iv_json is initial ) = boolc( io_json is initial ).
      z5ui5_cx_ajson_error=>raise( 'Either supply JSON string or instance, but not both' ).
    endif.

    if iv_json is not initial.
      ro_json = z5ui5_cl_ajson=>parse( iv_json ).
    elseif io_json is not initial.
      ro_json = io_json.
    else.
      z5ui5_cx_ajson_error=>raise( 'Supply either JSON string or instance' ).
    endif.
  ...
  method sort.
    ...
    data lo_json type ref to z5ui5_if_ajson.
