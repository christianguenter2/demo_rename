...
class ltcl_error implementation.
  ...
  method raise.
    ...
    try.
      z3ui5_cx_ajson_error=>raise( lv_msg ).
  ...
  method raise_w_location.
    ...
    try.
      z3ui5_cx_ajson_error=>raise( iv_msg = 'a' iv_location = 'b' ).
      cl_abap_unit_assert=>fail( ).
    catch z3ui5_cx_ajson_error into lx.
      cl_abap_unit_assert=>assert_equals(
        exp = 'a @b'
  ...
  method raise_w_node.
    ...
    try.
      z3ui5_cx_ajson_error=>raise( iv_msg = 'a' is_node = ls_node ).
      cl_abap_unit_assert=>fail( ).
    catch z3ui5_cx_ajson_error into lx.
      cl_abap_unit_assert=>assert_equals(
        exp = 'a @/x/y'
  ...
  method set_location.
    ...
    try.
      z3ui5_cx_ajson_error=>raise( iv_msg = 'a' ).
      cl_abap_unit_assert=>fail( ).
    catch z3ui5_cx_ajson_error into lx.
      cl_abap_unit_assert=>assert_equals(
        exp = lx->location
