...
class lcl_empty_filter implementation.
  method z5ui5_if_ajson_filter~keep_node.
    ...
    rv_keep = boolc(
      ( iv_visit = z5ui5_if_ajson_filter=>visit_type-value and is_node-value is not initial ) or
      ( iv_visit <> z5ui5_if_ajson_filter=>visit_type-value and is_node-children > 0 ) ).
...
class lcl_paths_filter implementation.
  ...
  method constructor.
    ...
    if boolc( iv_skip_paths is initial ) = boolc( it_skip_paths is initial ). " XOR
      z5ui5_cx_ajson_error=>raise( 'no filter path specified' ).
    endif.
  ...
  public section.
    ...
    methods constructor
      ...
      raising
        z5ui5_cx_ajson_error.
  private section.
    data mt_filters type z5ui5_if_ajson_filter=>ty_filter_tab.
endclass.
