...
class lcl_nodes_helper definition final.
  public section.
    ...
    data mt_nodes type z3ui5_if_ajson_types=>ty_nodes_tt read-only.
...
class ltcl_json_utils definition
  ...
  private section.
    ...
    methods json_diff for testing raising z3ui5_cx_ajson_error.
    methods json_diff_types for testing raising z3ui5_cx_ajson_error.
    methods json_diff_arrays for testing raising z3ui5_cx_ajson_error.
    methods json_merge for testing raising z3ui5_cx_ajson_error.
    methods json_sort for testing raising z3ui5_cx_ajson_error.
    methods is_equal for testing raising z3ui5_cx_ajson_error.
...
class ltcl_json_utils implementation.
  ...
  method json_diff.
    ...
    data:
      lv_json       type string,
      lo_util       type ref to z3ui5_cl_ajson_utilities,
      lo_insert     type ref to z3ui5_if_ajson,
      lo_delete     type ref to z3ui5_if_ajson,
      lo_change     type ref to z3ui5_if_ajson,
...
*      '        "row": 4,\n' && " array delete
  ...
  method json_merge.
    ...
    data:
      ...
      lv_json_b    type string,
      lo_util      type ref to z3ui5_cl_ajson_utilities,
      lo_merge     type ref to z3ui5_if_ajson,
