  ...
  method z5ui5_if_ajson_mapping~rename_node.
    ...
    case mv_rename_by.
      ...
      when z5ui5_cl_ajson_mapping=>rename_by-full_path.
        ...
        lv_pair_found = boolc( sy-subrc = 0 ).
      when z5ui5_cl_ajson_mapping=>rename_by-pattern.
        lv_full_path = is_node-path && cv_name.
...
class lcl_mapping_to_upper implementation.
  ...
  method constructor.
    ...
    mi_mapping_fields = z5ui5_cl_ajson_mapping=>create_field_mapping( it_mapping_fields ).
